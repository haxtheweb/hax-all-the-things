define(["exports","meta","require","../../../lit-element/lit-element.js","../../../@polymer/polymer/lib/utils/settings.js","../../utils/utils.js","../../hax-body-behaviors/hax-body-behaviors.js","../../code-sample/code-sample.js","../../../@polymer/iron-ajax/iron-ajax.js","../../simple-toast/simple-toast.js","./hax-app.js","./hax-stax.js","./hax-blox.js","../../../undoer/undoer.js"],function(_exports,meta,_require,_litElement,_settings,_utils,_haxBodyBehaviors,_codeSample,_ironAjax,_simpleToast,_haxApp,_haxStax,_haxBlox,_undoer){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.UndoerElement=_exports.HaxStore=void 0,meta=babelHelpers.interopRequireWildcard(meta),_require=babelHelpers.interopRequireWildcard(_require);class HaxStore extends((0,_haxBodyBehaviors.HAXElement)(_litElement.LitElement)){static get styles(){return[_litElement.css`
        :host {
          display: none;
        }
