import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";class AwesomeExplosion extends PolymerElement{constructor(){super(),setTimeout(()=>{this.addEventListener("click",this._setPlaySound.bind(this)),this.addEventListener("mouseover",this._setPlaySound.bind(this)),this.addEventListener("mouseout",this._setStopSound.bind(this))},0)}static get template(){return html`
      <style>
        :host {
