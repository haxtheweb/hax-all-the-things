define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/polymer/lib/elements/custom-style.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/iron-icon/iron-icon.js", "../../../../@polymer/iron-list/iron-list.js", "../../../../@polymer/paper-card/paper-card.js", "../../../../@polymer/paper-item/paper-item-shared-styles.js", "../../../../@polymer/paper-button/paper-button.js", "../../../lrnsys-button/lrnsys-button.js", "../../../elmsln-loading/elmsln-loading.js", "../../../materializecss-styles/materializecss-styles.js"], function (_exports, _litElement, _customStyle, _ironAjax, _ironIcon, _ironList, _paperCard, _paperItemSharedStyles, _paperButton, _lrnsysButton, _elmslnLoading, _materializecssStyles) {
  ...
  function _templateObject4_f4c5dd10229911ea85c7378a1f0d905a() {
    ...
    _templateObject4_f4c5dd10229911ea85c7378a1f0d905a = function _templateObject4_f4c5dd10229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject3_f4c5dd10229911ea85c7378a1f0d905a() {
    ...
    _templateObject3_f4c5dd10229911ea85c7378a1f0d905a = function _templateObject3_f4c5dd10229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject2_f4c5dd10229911ea85c7378a1f0d905a() {
    ...
    _templateObject2_f4c5dd10229911ea85c7378a1f0d905a = function _templateObject2_f4c5dd10229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject_f4c5dd10229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style include=\"materializecss-styles paper-item-styles\">\n          :host {\n            display: block;\n          }\n        </style>\n      </custom-style>\n      <iron-ajax\n        auto=\"\"\n        url=\"", "\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n        @response=\"", "\"\n      ></iron-ajax>\n      <div id=\"loading\">\n        <h3>Loading..</h3>\n        <elmsln-loading color=\"grey-text\" size=\"large\"></elmsln-loading>\n      </div>\n      ", "\n    "]);

    _templateObject_f4c5dd10229911ea85c7378a1f0d905a = function _templateObject_f4c5dd10229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappBlockRecentProject, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_f4c5dd10229911ea85c7378a1f0d905a(), this.sourcePath, this.responseChanged, this.handleResponse, this.hasProject ? (0, _litElement.html)(_templateObject2_f4c5dd10229911ea85c7378a1f0d905a(), this.basePath, this.project.id, this.project.attributes.title, this._toArray(this.project.relationships.assignments), this.project.id, this.assignment.id, this.basePath, this.assignment.metadata.relatedSubmissions.complete.color, this.assignment.metadata.relatedSubmissions.complete.icon, this.assignment.title) : (0, _litElement.html)(_templateObject3_f4c5dd10229911ea85c7378a1f0d905a(), this.basePath));
      }
    }, {
      key: "updated",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_f4c5dd10229911ea85c7378a1f0d905a())];
      }
    }, {
      key: "tag",
      get: function get() {
