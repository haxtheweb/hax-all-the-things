define(["exports", "../../../../lit-element/lit-element.js", "../../../secure-request/secure-request.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/paper-toast/paper-toast.js", "./lrnapp-studio-submission-page.js", "./lrnapp-studio-submission-button.js"], function (_exports, _litElement, _secureRequest, _appLocation, _appRoute, _paperToast, _lrnappStudioSubmissionPage, _lrnappStudioSubmissionButton) {
  ...
  function _templateObject4_43ddb1201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        paper-button {\n          padding: 0;\n          margin: 0;\n          min-width: 1rem;\n        }\n      "]);

    _templateObject4_43ddb1201b7411eab0b3b7b8d9dcf584 = function _templateObject4_43ddb1201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject3_43ddb1201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            This is the lrnapp-studio-submission page.\n          "]);

    _templateObject3_43ddb1201b7411eab0b3b7b8d9dcf584 = function _templateObject3_43ddb1201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_43ddb1201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <lrnapp-studio-submission-page\n              base-path=\"{", "\"\n              @base-path-changed=\"", "\"\n              .route=\"", "\"\n              @route-changed=\"", "\"\n              .data=\"", "\"\n              @data-changed=\"", "\"\n              id=\"", "\"\n              end-point=\"", "\"\n              csrf-token=\"", "\"\n            ></lrnapp-studio-submission-page>\n          "]);

    _templateObject2_43ddb1201b7411eab0b3b7b8d9dcf584 = function _templateObject2_43ddb1201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_43ddb1201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <app-location\n        .route=\"", "\"\n        @route-changed=\"", "\"\n      ></app-location>\n      <app-route\n        .route=\"", "\"\n        @route-changed=\"", "\"\n        pattern=\"", "/submissions/:submission\"\n        .data=\"", "\"\n        @data-changed=\"", "\"\n        .tail=\"", "\"\n        @tail-changed=\"", "\"\n      >\n      </app-route>\n      ", "\n      <paper-toast id=\"toast\"></paper-toast>\n    "]);

    _templateObject_43ddb1201b7411eab0b3b7b8d9dcf584 = function _templateObject_43ddb1201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_SecureRequestXhr) {
    ...
    babelHelpers.createClass(LrnappStudioSubmission, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_43ddb1201b7411eab0b3b7b8d9dcf584(), this.route, this.routeChangedEvent, this.route, this.routeChangedEvent, this.endPoint, this.data, this.dataChangedEvent, this.tail, this.tailChangedEvent, this.data.submission ? (0, _litElement.html)(_templateObject2_43ddb1201b7411eab0b3b7b8d9dcf584(), this.basePath, this.basePathChangedEvent, this.tail, this.tailChangedEvent, this.data, this.dataChangedEvent, this.data.submission, this.endPoint, this.csrfToken) : (0, _litElement.html)(_templateObject3_43ddb1201b7411eab0b3b7b8d9dcf584()));
      }
    }, {
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_43ddb1201b7411eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "tag",
      get: function get() {
