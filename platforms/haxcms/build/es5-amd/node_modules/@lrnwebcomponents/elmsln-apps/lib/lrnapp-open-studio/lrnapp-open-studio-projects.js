define(["exports", "require", "../../../../lit-element/lit-element.js", "../../../materializecss-styles/materializecss-styles.js", "../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _materializecssStyles, _customStyle) {
  ...
  function _templateObject6_412373201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <h1 class=\"empty-title black-text\">\n              Please select an Author and Project in order to review their\n              portfolio\n            </h1>\n          "]);

    _templateObject6_412373201b7411eab0b3b7b8d9dcf584 = function _templateObject6_412373201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject5_412373201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <a\n                  name=\"", "\"\n                  class=\"assignment-", "\"\n                  ><h2 class=\"assignment-title\">\n                    ", "\n                  </h2></a\n                >\n                <lrnapp-studio-submission-display\n                  .submission=\"", "\"\n                  class=\"ferpa-protect\"\n                ></lrnapp-studio-submission-display>\n              "]);

    _templateObject5_412373201b7411eab0b3b7b8d9dcf584 = function _templateObject5_412373201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject4_412373201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <lrnsys-button\n                    icon=\"", "\"\n                    icon-class=\"", "\"\n                    @click=\"", "\"\n                    label=\"", "\"\n                    data-assignment-id=\"", "\"\n                    class=\"project-step\"\n                    hover-class=\"blue white-text\"\n                    raised=\"\"\n                    ?hidden=\"", "\"\n                  ></lrnsys-button>\n                "]);

    _templateObject4_412373201b7411eab0b3b7b8d9dcf584 = function _templateObject4_412373201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject3_412373201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <h1 class=\"project-title black-text\">\n              ", "\n            </h1>\n            <div class=\"project-steps\">\n              ", "\n            </div>\n            ", "\n          "]);

    _templateObject3_412373201b7411eab0b3b7b8d9dcf584 = function _templateObject3_412373201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_412373201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style include=\"materializecss-styles\">\n          :host {\n            display: block;\n          }\n        </style>\n      </custom-style>\n      ", "\n    "]);

    _templateObject2_412373201b7411eab0b3b7b8d9dcf584 = function _templateObject2_412373201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_412373201b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          align-content: center;\n        }\n        h1.empty-title,\n        h1.project-title {\n          font-size: 2em;\n        }\n        h2.assignment-title {\n          font-size: 1.5em;\n          font-weight: bold;\n          width: 100%;\n          border-bottom: solid 1px grey;\n        }\n        .project-steps {\n          display: flex;\n          align-items: center;\n        }\n        .project-step {\n          overflow: hidden;\n          text-overflow: ellipsis;\n          word-break: break-all;\n          word-wrap: break-word;\n        }\n      "]);

    _templateObject_412373201b7411eab0b3b7b8d9dcf584 = function _templateObject_412373201b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappOpenStudioProjects, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_412373201b7411eab0b3b7b8d9dcf584())];
      }
    }]);
    ...
    babelHelpers.createClass(LrnappOpenStudioProjects, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_412373201b7411eab0b3b7b8d9dcf584(), this.showSubmissions ? (0, _litElement.html)(_templateObject3_412373201b7411eab0b3b7b8d9dcf584(), this.activeProject.attributes.title, this.activeProject.attributes.steps.map(function (assignment) {
          return (0, _litElement.html)(_templateObject4_412373201b7411eab0b3b7b8d9dcf584(), _this2._getSubmissionIcon(assignment.id), _this2._getSubmissionClass(assignment.id), _this2._scrollToTarget, assignment.title, assignment.id, !assignment.title);
        }), this.renderSubmissions.map(function (submission) {
          return (0, _litElement.html)(_templateObject5_412373201b7411eab0b3b7b8d9dcf584(), submission.relationships.assignment.title, submission.relationships.assignment.id, submission.relationships.assignment.title, submission);
        })) : (0, _litElement.html)(_templateObject6_412373201b7411eab0b3b7b8d9dcf584()));
      }
    }, {
      key: "updated",
