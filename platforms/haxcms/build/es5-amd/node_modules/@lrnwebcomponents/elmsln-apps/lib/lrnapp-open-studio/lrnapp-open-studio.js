define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/iron-list/iron-list.js", "../../../../@polymer/iron-pages/iron-pages.js", "../../../../@polymer/iron-selector/iron-selector.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/paper-dropdown-menu/paper-dropdown-menu.js", "../../../../@polymer/paper-listbox/paper-listbox.js", "../../../../@polymer/paper-item/paper-item.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../lrndesign-gallerycard/lrndesign-gallerycard.js", "../../../elmsln-loading/elmsln-loading.js", "./lrnapp-open-studio-table.js", "./lrnapp-open-studio-projects.js", "./lrnapp-open-studio-assignments.js"], function (_exports, _litElement, _ironAjax, _ironList, _ironPages, _ironSelector, _appToolbar, _appLocation, _appRoute, _paperDropdownMenu, _paperListbox, _paperItem, _paperToast, _lrndesignGallerycard, _elmslnLoading, _lrnappOpenStudioTable, _lrnappOpenStudioProjects, _lrnappOpenStudioAssignments) {
  ...
  function _templateObject5_414ec8e01b7411eab0b3b7b8d9dcf584() {
    ...
    _templateObject5_414ec8e01b7411eab0b3b7b8d9dcf584 = function _templateObject5_414ec8e01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject4_414ec8e01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject4_414ec8e01b7411eab0b3b7b8d9dcf584 = function _templateObject4_414ec8e01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject3_414ec8e01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject3_414ec8e01b7411eab0b3b7b8d9dcf584 = function _templateObject3_414ec8e01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_414ec8e01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject2_414ec8e01b7411eab0b3b7b8d9dcf584 = function _templateObject2_414ec8e01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_414ec8e01b7411eab0b3b7b8d9dcf584() {
    ...
    _templateObject_414ec8e01b7411eab0b3b7b8d9dcf584 = function _templateObject_414ec8e01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappOpenStudio, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_414ec8e01b7411eab0b3b7b8d9dcf584(), this.sourcePath, this.studioResponseChangedEvent, this._handleResponse, this.route, this.routeChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.route, this.routeChangedEvent, this.data, this.dataChangedEvent, this.tail, this.tailChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.endPoint, this.data.page, this.dataPageChangedEvent, this._submissionsClicked, this._projectsClicked, this._assignmentsClicked, this._tableClicked, this.submissions.length, this.originalSubmissions.length, !this.authors, this.queryParams.author, this.queryParamsAuthorEvent, this._toArray(this.authors).map(function (author) {
          return (0, _litElement.html)(_templateObject2_414ec8e01b7411eab0b3b7b8d9dcf584(), author.id, author.display_name);
        }), !this.projects, this.queryParams.project, this.queryParamsProjectEvent, this._toArray(this.projects).map(function (project) {
          return (0, _litElement.html)(_templateObject3_414ec8e01b7411eab0b3b7b8d9dcf584(), project.id, project.attributes.title);
          ...
          return (0, _litElement.html)(_templateObject4_414ec8e01b7411eab0b3b7b8d9dcf584(), assignment.id, assignment.attributes.title);
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_414ec8e01b7411eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "tag",
      get: function get() {
