define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-fieldset.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js", "./simple-fields-array-item.js"], function (_exports, _litElement, _simpleFieldsFieldset, _paperButton, _ironIcon, _ironIcons, _simpleFieldsArrayItem) {
  ...
  function _templateObject3_184c2870b4c611eaada595ac6eca7bce() {
    ...
    _templateObject3_184c2870b4c611eaada595ac6eca7bce = function _templateObject3_184c2870b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject2_184c2870b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"top\">\n        ", "\n        <paper-button\n          id=\"expand\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          ", "\n          <iron-icon\n            class=\"", "\"\n            aria-hidden=\"true\"\n            icon=\"expand-more\"\n          ></iron-icon>\n        </paper-button>\n      </div>\n      <div id=\"item-fields\" aria-live=\"polite\">\n        <slot></slot>\n        <paper-button\n          id=\"add\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          Add Item\n          <iron-icon aria-hidden=\"true\" icon=\"add\"></iron-icon>\n        </paper-button>\n      </div>\n    "]);

    _templateObject2_184c2870b4c611eaada595ac6eca7bce = function _templateObject2_184c2870b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_184c2870b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <fieldset>\n        ", "", "\n      </fieldset>\n    "]);

    _templateObject_184c2870b4c611eaada595ac6eca7bce = function _templateObject_184c2870b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_SimpleFieldsFieldset) {
    ...
    babelHelpers.createClass(SimpleFieldsArray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_184c2870b4c611eaada595ac6eca7bce(), this.legend, this.fields);
      }
    }, {
      key: "fields",
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject2_184c2870b4c611eaada595ac6eca7bce(), this.desc, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsArray), "styles", this)), [(0, _litElement.css)(_templateObject3_184c2870b4c611eaada595ac6eca7bce())]);
      }
    }, {
      key: "properties",
      get: function get() {
