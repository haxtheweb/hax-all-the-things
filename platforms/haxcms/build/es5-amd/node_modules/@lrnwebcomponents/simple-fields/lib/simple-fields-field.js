define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-container.js"], function (_exports, _litElement, _simpleFieldsContainer) {
  ...
  function _templateObject9_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <textarea\n        aria-invalid=\"", "\"\n        ?autofocus=\"", "\"\n        class=\"field box-input\"\n        @change=\"", "\"\n        @keydown=\"", "\"\n        ?disabled=\"", "\"\n        ?hidden=\"", "\"\n        @input=\"", "\"\n        .name=\"", "\"\n        ?readonly=\"", "\"\n        ?required=\"", "\"\n        rows=\"1\"\n      >\n", "</textarea\n      >\n    "]);

    _templateObject9_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject9_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject8_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <option\n              .id=\"", ".", "\"\n              ?selected=\"", "\"\n              .value=\"", "\"\n            >\n              ", "\n            </option>\n          "]);

    _templateObject8_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject8_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject7_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <select\n        ?autofocus=\"", "\"\n        aria-descrbedby=\"", "\"\n        aria-invalid=\"", "\"\n        @change=\"", "\"\n        class=\"field\"\n        ?disabled=\"", "\"\n        ?hidden=\"", "\"\n        ?multiple=\"", "\"\n        .name=\"", "\"\n        ?readonly=\"", "\"\n        ?required=\"", "\"\n      >\n        ", "\n      </select>\n    "]);

    _templateObject7_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject7_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject6_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <input\n        aria-descrbedby=\"", "\"\n        aria-invalid=\"", "\"\n        ?autofocus=\"", "\"\n        @change=\"", "\"\n        ?checked=\"", "\"\n        class=\"field ", "\"\n        ?disabled=\"", "\"\n        ?hidden=\"", "\"\n        @input=\"", "\"\n        .name=\"", "\"\n        .placeholder=\"", "\"\n        ?readonly=\"", "\"\n        ?required=\"", "\"\n        .type=\"", "\"\n      />\n    "]);

    _templateObject6_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject6_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject5_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"option inline\">\n                <label for=\"", ".", "\" class=\"radio-label\"\n                  >", "</label\n                >\n                <input\n                  .id=\"", "\"\n                  .name=\"", "\"\n                  ?autofocus=\"", "\"\n                  aria-descrbedby=\"", "\"\n                  .aria-invalid=\"", "\"\n                  ?checked=\"", "\"\n                  class=\"field\"\n                  @click=\"", "\"\n                  ?disabled=\"", "\"\n                  ?hidden=\"", "\"\n                  ?readonly=\"", "\"\n                  ?required=\"", "\"\n                  type=\"", "\"\n                  .value=\"", "\"\n                />\n              </div>\n            "]);

    _templateObject5_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject5_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject4_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <fieldset>\n        <legend class=\"label-main\" ?hidden=\"", "\">\n          ", "", "\n        </legend>\n        <div id=\"options\">\n          ", "\n        </div>\n        ", "\n      </fieldset>\n    "]);

    _templateObject4_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject4_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"fieldmeta\" aria-live=\"polite\"></div>\n    "]);

    _templateObject3_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject3_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div\n        class=\"", "\"\n      >\n        ", "\n        <div>\n          ", "\n          ", "\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject2_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject2_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_bacdc7e08a2611eaafc8a9b4dccb8bbb = function _templateObject_bacdc7e08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_SimpleFieldsContaine) {
    ...
    babelHelpers.createClass(SimpleFieldsField, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsField), "styles", this)), [(0, _litElement.css)(_templateObject_bacdc7e08a2611eaafc8a9b4dccb8bbb())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimpleFieldsField, [{
      ...
      key: "fieldMeta",
      get: function get() {
        return (0, _litElement.html)(_templateObject3_bacdc7e08a2611eaafc8a9b4dccb8bbb());
      }
      /**
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject4_bacdc7e08a2611eaafc8a9b4dccb8bbb(), !this.label, this.label, this.error || this.required ? "*" : "", (this.sortedOptions || []).map(function (option) {
          return (0, _litElement.html)(_templateObject5_bacdc7e08a2611eaafc8a9b4dccb8bbb(), _this4.id, option.value, option.text, option.value, _this4.id, _this4.autofocus, _this4.describedBy, _this4.error ? "true" : "false", _this4.type === "radio" ? _this4.value === option.value : (_this4.value || []).includes(option.value), function (e) {
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject6_bacdc7e08a2611eaafc8a9b4dccb8bbb(), this.describedBy, this.error ? "true" : "false", this.autofocus, function (e) {
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject7_bacdc7e08a2611eaafc8a9b4dccb8bbb(), this.autofocus, this.describedBy, this.error ? "true" : "false", function (e) {
          ...
          return (0, _litElement.html)(_templateObject8_bacdc7e08a2611eaafc8a9b4dccb8bbb(), _this7.id, option.value, _this7.multiple ? _this7.value && _this7.value.includes(option.value) : _this7.value === option.value, option.value, option.text);
        }));
      }
      /**
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject9_bacdc7e08a2611eaafc8a9b4dccb8bbb(), this.error ? "true" : "false", this.autofocus, function (e) {
