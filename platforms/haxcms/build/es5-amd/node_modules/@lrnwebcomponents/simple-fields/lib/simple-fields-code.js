define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-container.js", "../../code-editor/code-editor.js"], function (_exports, _litElement, _simpleFieldsContainer, _codeEditor) {
  ...
  function _templateObject2_bab844108a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"field-main\">\n        <code-editor\n          ?autofocus=\"", "\"\n          ?disabled=\"", "\"\n          font-size=\"", "\"\n          editor-value=\"", "\"\n          theme=\"", "\"\n          language=\"", "\"\n          mode=\"", "\"\n          ?read-only=\"", "\"\n          @value-changed=\"", "\"\n        >\n        </code-editor>\n        <input name=\"", "\" type=\"hidden\" value=\"", "\" />\n      </div>\n    "]);

    _templateObject2_bab844108a2611eaafc8a9b4dccb8bbb = function _templateObject2_bab844108a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_bab844108a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_bab844108a2611eaafc8a9b4dccb8bbb = function _templateObject_bab844108a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_SimpleFieldsContaine) {
    ...
    babelHelpers.createClass(SimpleFieldsCode, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsCode), "styles", this)), [(0, _litElement.css)(_templateObject_bab844108a2611eaafc8a9b4dccb8bbb())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimpleFieldsCode, [{
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject2_bab844108a2611eaafc8a9b4dccb8bbb(), this.autofocus, this.disabled, this.fontSize, this.__editorValue || "", this.theme, this.language, this.mode, this.readonly || this.disabled, this._onChange, this.id, this.value);
      }
    }, {
