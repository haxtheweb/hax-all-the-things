define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_b49909208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-dialog modal>\n        <h2>", "</h2>\n        <div class=\"content\"><slot name=\"content\"></slot></div>\n        <div class=\"buttons\"><slot name=\"buttons\"></slot></div>\n      </paper-dialog>\n    "]);

    _templateObject2_b49909208a2611eaafc8a9b4dccb8bbb = function _templateObject2_b49909208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b49909208a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b49909208a2611eaafc8a9b4dccb8bbb = function _templateObject_b49909208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GameShowQuizModal, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_b49909208a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(GameShowQuizModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_b49909208a2611eaafc8a9b4dccb8bbb(), this.title);
      }
      /**
