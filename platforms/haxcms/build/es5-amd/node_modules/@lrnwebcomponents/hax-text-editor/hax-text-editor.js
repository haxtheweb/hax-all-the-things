define(["exports", "../../@polymer/polymer/polymer-element.js", "../rich-text-editor/rich-text-editor.js", "./lib/hax-text-editor-toolbar.js"], function (_exports, _polymerElement, _richTextEditor, _haxTextEditorToolbar) {
  ...
  function _templateObject_a2bae8908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style></style>\n      ", "\n    "]);

    _templateObject_a2bae8908a2611eaafc8a9b4dccb8bbb = function _templateObject_a2bae8908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_RichTextEditor) {
    ...
    babelHelpers.createClass(HaxTextEditor, null, [{
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_a2bae8908a2611eaafc8a9b4dccb8bbb(), babelHelpers.get(babelHelpers.getPrototypeOf(HaxTextEditor), "template", this));
