define(["exports", "../../lit-element/lit-element.js", "../json-editor/json-editor.js", "../code-editor/code-editor.js", "../../@vaadin/vaadin-split-layout/vaadin-split-layout.js", "../../@polymer/paper-button/paper-button.js", "../hax-body/lib/hax-schema-form.js", "../hax-body-behaviors/hax-body-behaviors.js"], function (_exports, _litElement, _jsonEditor, _codeEditor, _vaadinSplitLayout, _paperButton, _haxSchemaForm, _haxBodyBehaviors) {
  ...
  function _templateObject2_06133db0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n        code-editor {\n          height: 500px;\n        }\n      "]);

    _templateObject2_06133db0b4c611eaada595ac6eca7bce = function _templateObject2_06133db0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_06133db0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <vaadin-split-layout>\n        <div>\n          <paper-button raised noink @click=\"", "\"\n            >Add to configure</paper-button\n          >\n          <paper-button raised noink @click=\"", "\"\n            >Add to advanced</paper-button\n          >\n          <code-editor\n            id=\"code\"\n            @value-changed=\"", "\"\n            .value=\"{}\"\n            language=\"json\"\n          ></code-editor>\n          <json-editor\n            id=\"json\"\n            label=\"JSON\"\n            @value-changed=\"", "\"\n            value=\"", "\"\n          ></json-editor>\n        </div>\n        <div>\n          <hax-schema-form\n            id=\"form\"\n            value=\"", "\"\n            @value-changed=\"", "\"\n          ></hax-schema-form>\n        </div>\n      </vaadin-split-layout>\n    "]);

    _templateObject_06133db0b4c611eaada595ac6eca7bce = function _templateObject_06133db0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxschemaBuilder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_06133db0b4c611eaada595ac6eca7bce(), this.addConfigure, this.addAdvanced, this._editorDataChanged, this.__haxSchemaChanged, this.haxSchema, this.value, this.__valueChanged);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_06133db0b4c611eaada595ac6eca7bce())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
