define(["exports", "../../../../@polymer/polymer/polymer-element.js", "./rich-text-editor-toolbar.js", "./rich-text-editor-breadcrumbs.js"], function (_exports, _polymerElement, _richTextEditorToolbar, _richTextEditorBreadcrumbs) {
  ...
  function _templateObject_bd8e20608a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", " ", " ", "\n    "]);

    _templateObject_bd8e20608a2611eaafc8a9b4dccb8bbb = function _templateObject_bd8e20608a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_RichTextEditorToolba) {
    ...
    babelHelpers.createClass(RichTextEditorToolbarFull, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_bd8e20608a2611eaafc8a9b4dccb8bbb(), this.styleTemplate, this.stickyTemplate, this.toolbarTemplate);
