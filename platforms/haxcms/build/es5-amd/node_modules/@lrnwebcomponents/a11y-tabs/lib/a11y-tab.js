define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcons) {
  ...
  function _templateObject2_b38c54108a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          height: var(--a11y-tabs-tab-height, --a11y-tabs-height);\n          overflow: var(--a11y-tabs-tab-overflow, --a11y-tabs-overflow);\n        }\n        /*:host([disabled]) {\n          display:none;\n        }*/\n        :host([hidden]) {\n          display: none;\n        }\n        .sr-only {\n          position: absolute;\n          left: -99999px;\n          height: 0;\n          overflow: hidden;\n        }\n        #content-inner {\n          max-width: 100%;\n          overflow: auto;\n        }\n        ::slotted(*[slot=\"label\"]) {\n          display: none;\n        }\n      "]);

    _templateObject2_b38c54108a2611eaafc8a9b4dccb8bbb = function _templateObject2_b38c54108a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b38c54108a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"sr-only\">Tab ", "</span>\n      <slot name=\"label\"></slot>\n      <div id=\"content-inner\"><slot></slot></div>\n      <span class=\"sr-only\">\n        End of tab ", ". Back to <a href=\"#", "\">tabs</a>.\n      </span>\n    "]);

    _templateObject_b38c54108a2611eaafc8a9b4dccb8bbb = function _templateObject_b38c54108a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(A11yTab, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b38c54108a2611eaafc8a9b4dccb8bbb(), this.xOfY, this.xOfY, this.id);
      } // properties available to the custom element for data binding

    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b38c54108a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
