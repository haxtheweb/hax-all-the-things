define(["exports", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _litElement, _schemaBehaviors) {
  ...
  function _templateObject5_b2ba37008a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject5_b2ba37008a2611eaafc8a9b4dccb8bbb = function _templateObject5_b2ba37008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject4_b2ba37008a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <span property=\"oer:task\">", "</span>\n                  "]);

    _templateObject4_b2ba37008a2611eaafc8a9b4dccb8bbb = function _templateObject4_b2ba37008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_b2ba37008a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <a href=\"", "\" property=\"oer:task\">", "</a>\n                  "]);

    _templateObject3_b2ba37008a2611eaafc8a9b4dccb8bbb = function _templateObject3_b2ba37008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b2ba37008a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>\n              ", "\n            </li>\n          "]);

    _templateObject2_b2ba37008a2611eaafc8a9b4dccb8bbb = function _templateObject2_b2ba37008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b2ba37008a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h3><span property=\"oer:name\">", "</span></h3>\n      <ol>\n        ", "\n      </ol>\n    "]);

    _templateObject_b2ba37008a2611eaafc8a9b4dccb8bbb = function _templateObject_b2ba37008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(TaskList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b2ba37008a2611eaafc8a9b4dccb8bbb(), this.name, this.tasks.map(function (task) {
          return (0, _litElement.html)(_templateObject2_b2ba37008a2611eaafc8a9b4dccb8bbb(), task.link ? (0, _litElement.html)(_templateObject3_b2ba37008a2611eaafc8a9b4dccb8bbb(), task.link, task.name) : (0, _litElement.html)(_templateObject4_b2ba37008a2611eaafc8a9b4dccb8bbb(), task.name));
        }));
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_b2ba37008a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "tag",
      get: function get() {
