define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_efe98260229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        iron-icon {\n          display: inline-block;\n          height: 16px;\n          width: 16px;\n        }\n      "]);

    _templateObject2_efe98260229911ea85c7378a1f0d905a = function _templateObject2_efe98260229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject_efe98260229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <iron-icon icon=\"", "\"></iron-icon> ", "\n      </paper-button>\n      <paper-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject_efe98260229911ea85c7378a1f0d905a = function _templateObject_efe98260229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_efe98260229911ea85c7378a1f0d905a(), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_efe98260229911ea85c7378a1f0d905a())];
      }
    }, {
      key: "tag",
      get: function get() {
