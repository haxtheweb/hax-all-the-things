define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_2fa685601b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        iron-icon {\n          display: inline-block;\n          height: 16px;\n          width: 16px;\n        }\n      "]);

    _templateObject2_2fa685601b7411eab0b3b7b8d9dcf584 = function _templateObject2_2fa685601b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_2fa685601b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <iron-icon icon=\"", "\"></iron-icon> ", "\n      </paper-button>\n      <paper-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject_2fa685601b7411eab0b3b7b8d9dcf584 = function _templateObject_2fa685601b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2fa685601b7411eab0b3b7b8d9dcf584(), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_2fa685601b7411eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "tag",
      get: function get() {
