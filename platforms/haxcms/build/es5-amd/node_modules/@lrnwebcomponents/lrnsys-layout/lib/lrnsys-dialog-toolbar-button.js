define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_150f4cf0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        iron-icon {\n          display: inline-block;\n          height: 16px;\n          width: 16px;\n        }\n      "]);

    _templateObject2_150f4cf0b4c611eaada595ac6eca7bce = function _templateObject2_150f4cf0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_150f4cf0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <iron-icon icon=\"", "\"></iron-icon> ", "\n      </paper-button>\n      <simple-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject_150f4cf0b4c611eaada595ac6eca7bce = function _templateObject_150f4cf0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_150f4cf0b4c611eaada595ac6eca7bce(), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_150f4cf0b4c611eaada595ac6eca7bce())];
      }
    }, {
      key: "tag",
      get: function get() {
