define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../accent-card/accent-card.js", "../../nav-card/nav-card.js", "../../progress-donut/progress-donut.js", "../../lrndesign-avatar/lrndesign-avatar.js"], function (_exports, _litElement, _ironAjax, _accentCard, _navCard, _progressDonut, _lrndesignAvatar) {
  ...
  function _templateObject7_12826080b4c611eaada595ac6eca7bce() {
    ...
    _templateObject7_12826080b4c611eaada595ac6eca7bce = function _templateObject7_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject6_12826080b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <nav-card-item\n                icon=\"chevron-right\"\n                avatar=\"", "\"\n                initials=\"", "\"\n              >\n                <button\n                  id=\"activity-", "\"\n                  aria-describedby=\"activity-desc-", "\"\n                  slot=\"label\"\n                >\n                  ", "\n                  ", "\n                  ", "\n                </button>\n                <span id=\"activity-desc-", "\" slot=\"description\">\n                  ", "\n                </span>\n              </nav-card-item>\n            "]);

    _templateObject6_12826080b4c611eaada595ac6eca7bce = function _templateObject6_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject5_12826080b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <nav-card-item icon=\"chevron-right\">\n                    <button\n                      id=\"comment-", "\"\n                      aria-describedby=\"comment-desc-", "\"\n                      slot=\"label\"\n                    >\n                      ", "\n                    </button>\n                    <span id=\"comment-", "\" slot=\"description\"\n                      >", "</span\n                    >\n                  </nav-card-item>\n                "]);

    _templateObject5_12826080b4c611eaada595ac6eca7bce = function _templateObject5_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject4_12826080b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <nav-card-item icon=\"chevron-right\">\n                    <button\n                      id=\"submission-", "\"\n                      aria-describedby=\"submission-desc-", "\"\n                      slot=\"label\"\n                    >\n                      ", "\n                    </button>\n                    <span id=\"submission-desc-", "\" slot=\"description\"\n                      >", "</span\n                    >\n                  </nav-card-item>\n                "]);

    _templateObject4_12826080b4c611eaada595ac6eca7bce = function _templateObject4_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject3_12826080b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            Due\n                            ", "\n                          "]);

    _templateObject3_12826080b4c611eaada595ac6eca7bce = function _templateObject3_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject2_12826080b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <nav-card-item icon=\"chevron-right\">\n                    <button\n                      id=\"due-", "\"\n                      aria-describedby=\"due-desc-", "\"\n                      slot=\"label\"\n                    >\n                      ", "\n                    </button>\n                    <span id=\"due-desc-", "\" slot=\"description\">\n                      ", "\n                    </span>\n                  </nav-card-item>\n                "]);

    _templateObject2_12826080b4c611eaada595ac6eca7bce = function _templateObject2_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_12826080b4c611eaada595ac6eca7bce() {
    ...
    _templateObject_12826080b4c611eaada595ac6eca7bce = function _templateObject_12826080b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ElmslnStudioDashboard, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_12826080b4c611eaada595ac6eca7bce(), this.activitySrc, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_12826080b4c611eaada595ac6eca7bce(), i, i, assign.attributes.title, i, _this2._getDueDate(assign) ? (0, _litElement.html)(_templateObject3_12826080b4c611eaada595ac6eca7bce(), _this2.date(parseInt(_this2._getDueDate(assign)) * 1000)) : "");
        }), Object.keys(this.__submissions).map(function (submission, i) {
          return (0, _litElement.html)(_templateObject4_12826080b4c611eaada595ac6eca7bce(), i, i, _this2.__submissions[submission].attributes.title, i, _this2.date(_this2.__submissions[submission].meta.changed));
        }), this.__comments.map(function (comment, i) {
          return (0, _litElement.html)(_templateObject5_12826080b4c611eaada595ac6eca7bce(), i, i, comment.attributes.subject, i, _this2.date(comment.attributes.changed));
        }), this.__activity.map(function (activity, i) {
          return (0, _litElement.html)(_templateObject6_12826080b4c611eaada595ac6eca7bce(), activity.relationships.author.data.avatar || "", activity.relationships.author.data.display_name || "", i, i, activity.relationships.author.data.sis.sortable_name.replace(/.*,/, ""), activity.type === "comment" ? "commented" : "submitted", activity.type === "comment" ? activity.attributes.subject : activity.attributes.title, i, _this2.date(activity.type === "comment" ? activity.attributes.changed : activity.meta.changed));
        }));
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject7_12826080b4c611eaada595ac6eca7bce())];
      }
    }, {
      key: "properties",
      get: function get() {
