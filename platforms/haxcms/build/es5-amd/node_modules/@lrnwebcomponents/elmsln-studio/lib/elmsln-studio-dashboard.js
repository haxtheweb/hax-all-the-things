define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../accent-card/accent-card.js", "../../a11y-collapse/a11y-collapse.js", "../../progress-donut/progress-donut.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironAjax, _accentCard, _a11yCollapse, _progressDonut, _ironIcons) {
  ...
  function _templateObject7_b47183f08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject7_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject7_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject6_b47183f08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <li>\n                <iron-icon aria-hidden=\"true\" icon=\"chevron-right\"></iron-icon>\n                <button class=\"linklist-heading\">\n                  ", "\n                  ", "\n                  ", "\n                </button>\n                <span class=\"linklist-subheading\">\n                  ", "\n                </span>\n              </li>\n            "]);

    _templateObject6_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject6_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject5_b47183f08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "</span\n                    >\n                  </li>\n                "]);

    _templateObject5_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject5_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject4_b47183f08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "</span\n                    >\n                  </li>\n                "]);

    _templateObject4_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject4_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_b47183f08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            Due\n                            ", "\n                          "]);

    _templateObject3_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject3_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b47183f08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "\n                    </span>\n                  </li>\n                "]);

    _templateObject2_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject2_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b47183f08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b47183f08a2611eaafc8a9b4dccb8bbb = function _templateObject_b47183f08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ElmslnStudioDashboard, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_b47183f08a2611eaafc8a9b4dccb8bbb(), this.activitySrc, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_b47183f08a2611eaafc8a9b4dccb8bbb(), assign.attributes.title, _this2._getDueDate(assign) ? (0, _litElement.html)(_templateObject3_b47183f08a2611eaafc8a9b4dccb8bbb(), _this2.date(parseInt(_this2._getDueDate(assign)) * 1000)) : "");
        }), Object.keys(this.__submissions).map(function (submission) {
          return (0, _litElement.html)(_templateObject4_b47183f08a2611eaafc8a9b4dccb8bbb(), _this2.__submissions[submission].attributes.title, _this2.date(_this2.__submissions[submission].meta.changed));
        }), this.__comments.map(function (comment) {
          return (0, _litElement.html)(_templateObject5_b47183f08a2611eaafc8a9b4dccb8bbb(), comment.attributes.subject, _this2.date(comment.attributes.changed));
        }), this.__activity.map(function (activity) {
          return (0, _litElement.html)(_templateObject6_b47183f08a2611eaafc8a9b4dccb8bbb(), activity.relationships.author.data.sis.sortable_name.replace(/.*,/, ""), activity.type === "comment" ? "commented" : "submitted", activity.type === "comment" ? activity.attributes.subject : activity.attributes.title, _this2.date(activity.type === "comment" ? activity.attributes.changed : activity.meta.changed));
        }));
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject7_b47183f08a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
