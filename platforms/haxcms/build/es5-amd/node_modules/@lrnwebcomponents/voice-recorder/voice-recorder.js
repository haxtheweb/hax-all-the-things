define(["exports", "meta", "require", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js"], function (_exports, meta, _require, _litElement, _vmsgFork) {
  ...
  function _templateObject2_b3174b208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_b3174b208a2611eaafc8a9b4dccb8bbb = function _templateObject2_b3174b208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b3174b208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <iron-icon icon=\"", "\"></iron-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_b3174b208a2611eaafc8a9b4dccb8bbb = function _templateObject_b3174b208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b3174b208a2611eaafc8a9b4dccb8bbb(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b3174b208a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
