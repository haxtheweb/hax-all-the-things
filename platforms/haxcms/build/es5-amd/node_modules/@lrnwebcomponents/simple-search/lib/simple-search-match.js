define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject2_bb48c4408a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject2_bb48c4408a2611eaafc8a9b4dccb8bbb = function _templateObject2_bb48c4408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_bb48c4408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);

    _templateObject_bb48c4408a2611eaafc8a9b4dccb8bbb = function _templateObject_bb48c4408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleSearchMatch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_bb48c4408a2611eaafc8a9b4dccb8bbb());
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_bb48c4408a2611eaafc8a9b4dccb8bbb())];
      }
    }]);
