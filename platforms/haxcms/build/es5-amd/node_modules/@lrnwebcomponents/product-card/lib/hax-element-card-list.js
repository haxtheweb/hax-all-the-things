define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../../@material/mwc-button/mwc-button.js", "../../simple-modal/simple-modal.js", "../../hexagon-loader/hexagon-loader.js", "../product-card.js"], function (_exports, _require, _litElement, _utils, _mwcButton, _simpleModal, _hexagonLoader, _productCard) {
  ...
  function _templateObject8_b9219e808a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject8_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject8_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject7_b9219e808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                              <mwc-button\n                                data-tag=\"", "\"\n                                outlined\n                                @click=\"", "\"\n                                >Pop up demo</mwc-button\n                              >\n                              <div class=\"demo\">\n                                ", "\n                              </div>\n                              <code-sample copy-clipboard-button>\n                                <template>\n                                  ", "\n                                </template>\n                              </code-sample>\n                            "]);

    _templateObject7_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject7_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject6_b9219e808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          ", "\n                        "]);

    _templateObject6_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject6_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject5_b9219e808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                                <li>\n                                  <strong>", ":</strong>\n                                  <span>", "</span>\n                                </li>\n                              "]);

    _templateObject5_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject5_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject4_b9219e808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            ", "\n                          "]);

    _templateObject4_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject4_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_b9219e808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                              ", ",\n                            "]);

    _templateObject3_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject3_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b9219e808a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject2_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject2_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b9219e808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <p class=\"loaderText\" ?hidden=\"", "\">\n            Loading HAX elements..\n          </p>\n          <hexagon-loader\n            item-count=\"4\"\n            color=\"blue\"\n            ?loading=\"", "\"\n            size=\"large\"\n          ></hexagon-loader>\n          <div\n            class=\"grid\"\n            style=\"--hax-element-card--cols: repeat(", ", 1fr)\"\n          >\n            ", "\n          </div>\n        "]);

    _templateObject_b9219e808a2611eaafc8a9b4dccb8bbb = function _templateObject_b9219e808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXElementCardList, [{
      ...
      value: function render() {
        ...
        return !this.showCardList ? "" : (0, _litElement.html)(_templateObject_b9219e808a2611eaafc8a9b4dccb8bbb(), !this.loading, this.loading, this.cols, this.productList.map(function (el, i) {
          return (0, _litElement.html)(_templateObject2_b9219e808a2611eaafc8a9b4dccb8bbb(), _this2.__getCol(i), !el.status, !(_this2.filteredTags && _this2.filteredTags.includes(el.tag)), el.schema.demoSchema, el.schema.gizmo.title, el.schema.gizmo.icon, el.schema.gizmo.description, el.schema.gizmo.color, function (e) {
            ...
            return (0, _litElement.html)(_templateObject3_b9219e808a2611eaafc8a9b4dccb8bbb(), group);
          }), el.tag, el.file, el.schema.gizmo.meta ? (0, _litElement.html)(_templateObject4_b9219e808a2611eaafc8a9b4dccb8bbb(), Object.keys(el.schema.gizmo.meta).map(function (mel) {
            return (0, _litElement.html)(_templateObject5_b9219e808a2611eaafc8a9b4dccb8bbb(), _this2.capFirst(mel), el.schema.gizmo.meta[mel]);
          })) : "", el.schema.demoSchema && el.showDemo ? (0, _litElement.html)(_templateObject6_b9219e808a2611eaafc8a9b4dccb8bbb(), el.schema.demoSchema.map(function (demoItem) {
            return (0, _litElement.html)(_templateObject7_b9219e808a2611eaafc8a9b4dccb8bbb(), demoItem.tag, _this2._viewDemo, _this2._haxElementToNode(demoItem), _this2._haxElementToNode(demoItem));
          })) : "");
        }));
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_b9219e808a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
