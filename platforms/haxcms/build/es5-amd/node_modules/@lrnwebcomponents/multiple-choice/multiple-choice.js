define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _litElement, _schemaBehaviors, _simpleColors) {
  ...
  function _templateObject8_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <div id=\"buttons\">\n              <paper-button\n                id=\"check\"\n                ?disabled=\"", "\"\n                raised\n                @click=\"", "\"\n                >", "</paper-button\n              >\n              <paper-button\n                id=\"reset\"\n                ?disabled=\"", "\"\n                raised\n                @click=\"", "\"\n                >", "</paper-button\n              >\n            </div>\n          "]);

    _templateObject8_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject8_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject7_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <paper-checkbox\n                      ?disabled=\"", "\"\n                      property=\"oer:answer\"\n                      name=\"", "\"\n                      ?checked=\"", "\"\n                      @checked-changed=\"", "\"\n                      >", "</paper-checkbox\n                    >\n                  </li>\n                "]);

    _templateObject7_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject7_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject6_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <ul>\n              ", "\n            </ul>\n          "]);

    _templateObject6_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject6_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject5_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <paper-radio-button\n                    ?disabled=\"", "\"\n                    property=\"oer:answer\"\n                    name=\"", "\"\n                    ?checked=\"", "\"\n                    @checked-changed=\"", "\"\n                    >", "</paper-radio-button\n                  >\n                "]);

    _templateObject5_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject5_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject4_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <paper-radio-group>\n              ", "\n            </paper-radio-group>\n          "]);

    _templateObject4_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject4_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject3_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <h3><span property=\"oer:name\">", "</span></h3>\n          "]);

    _templateObject3_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject3_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <meta property=\"oer:assessing\" content=\"", "\" />\n      ", "\n      <div>", "</div>\n      ", "\n      ", "\n      <paper-toast\n        id=\"toast\"\n        scroll-action=\"cancel\"\n        duration=\"6000\"\n        position-target=\"", "\"\n        class=\"fit-bottom ", "\"\n      >\n        ", "\n        <iron-icon\n          icon=\"", "\"\n          style=\"margin-left:16px;\"\n        ></iron-icon>\n      </paper-toast>\n    "]);

    _templateObject2_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject2_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_0d80e9d01b7411eab0b3b7b8d9dcf584() {
    ...
    _templateObject_0d80e9d01b7411eab0b3b7b8d9dcf584 = function _templateObject_0d80e9d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(MultipleChoice, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(MultipleChoice), "styles", this)), [(0, _litElement.css)(_templateObject_0d80e9d01b7411eab0b3b7b8d9dcf584())]);
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(MultipleChoice, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_0d80e9d01b7411eab0b3b7b8d9dcf584(), this.relatedResource, this.title ? (0, _litElement.html)(_templateObject3_0d80e9d01b7411eab0b3b7b8d9dcf584(), this.title) : "", this.question, this.singleOption ? (0, _litElement.html)(_templateObject4_0d80e9d01b7411eab0b3b7b8d9dcf584(), this.displayedAnswers.map(function (answer, index) {
          return (0, _litElement.html)(_templateObject5_0d80e9d01b7411eab0b3b7b8d9dcf584(), _this3.disabled, index, answer.userGuess, _this3.checkedEvent, answer.label);
        })) : (0, _litElement.html)(_templateObject6_0d80e9d01b7411eab0b3b7b8d9dcf584(), this.displayedAnswers.map(function (answer, index) {
          return (0, _litElement.html)(_templateObject7_0d80e9d01b7411eab0b3b7b8d9dcf584(), _this3.disabled, index, answer.userGuess, _this3.checkedEvent, answer.label);
        })), !this.hideButtons ? (0, _litElement.html)(_templateObject8_0d80e9d01b7411eab0b3b7b8d9dcf584(), this.disabled, this._verifyAnswers, this.checkLabel, this.disabled, this.resetAnswers, this.resetLabel) : "", this.positionTarget, this.__toastColor, this.__toastText, this.__toastIcon);
      }
    }, {
      key: "checkedEvent",
