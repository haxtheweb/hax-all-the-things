define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_026891a0856511eaa66301b3a4f2e8c5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <map-menu-header\n        .avatar-label=\"", "\"\n        id=\"", "\"\n        title=\"", "\"\n        label=\"", "\"\n        ?opened=\"", "\"\n        url=\"", "\"\n        icon=\"", "\"\n        selected=\"", "\"\n      ></map-menu-header>\n      <iron-collapse id=\"container\"> <slot></slot> </iron-collapse>\n    "]);

    _templateObject2_026891a0856511eaa66301b3a4f2e8c5 = function _templateObject2_026891a0856511eaa66301b3a4f2e8c5() {
      return data;
    };
  ...
  function _templateObject_026891a0856511eaa66301b3a4f2e8c5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([collapsable]) > map-menu-header {\n          cursor: pointer;\n          display: block;\n        }\n        #container {\n          margin-left: 16px;\n        }\n        #container ::slotted(map-menu-item) {\n          margin-top: 0.4em;\n        }\n      "]);

    _templateObject_026891a0856511eaa66301b3a4f2e8c5 = function _templateObject_026891a0856511eaa66301b3a4f2e8c5() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MapMenuSubmenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_026891a0856511eaa66301b3a4f2e8c5())];
      }
    }]);
    ...
    babelHelpers.createClass(MapMenuSubmenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_026891a0856511eaa66301b3a4f2e8c5(), this.avatarLabel, this.id, this.title, this.label, this.opened, this.url, this.icon, this.selected);
      }
    }, {
      key: "updated",
