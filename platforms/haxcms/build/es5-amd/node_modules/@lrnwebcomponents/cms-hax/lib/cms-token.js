define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../../@polymer/paper-spinner/paper-spinner.js", "../../utils/utils.js"], function (_exports, _polymerElement, _renderStatus, _flattenedNodesObserver, _async, _ironAjax, _paperSpinner, _utils) {
  ...
  function _templateObject_11ca5b20b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: inline;\n          min-width: 112px;\n          min-height: 112px;\n          transition: 0.6s all ease;\n          background-color: transparent;\n        }\n\n        paper-spinner {\n          transition: 0.6s all ease;\n          position: absolute;\n          visibility: hidden;\n          display: none;\n          opacity: 0;\n          height: 0;\n          width: 0;\n        }\n\n        #replacementcontent {\n          transition: 0.6s all ease;\n          visibility: visible;\n          opacity: 1;\n          height: auto;\n          width: auto;\n        }\n\n        :host([loading]) {\n          text-align: center;\n        }\n\n        :host([loading]) paper-spinner {\n          visibility: visible;\n          opacity: 1;\n          position: relative;\n          height: 80px;\n          width: 80px;\n          padding: 16px;\n          display: flex;\n        }\n\n        :host([loading]) #replacementcontent {\n          opacity: 0;\n          visibility: hidden;\n          height: 0;\n          width: 0;\n        }\n      </style>\n      <iron-ajax\n        id=\"tokenrequest\"\n        method=\"GET\"\n        params=\"[[bodyData]]\"\n        url=\"[[tokenEndPoint]]\"\n        handle-as=\"json\"\n        last-response=\"{{tokenData}}\"\n      ></iron-ajax>\n      <paper-spinner active=\"[[loading]]\"></paper-spinner>\n      <span id=\"replacementcontent\">\n        <slot></slot>\n      </span>\n    "]);

    _templateObject_11ca5b20b4c611eaada595ac6eca7bce = function _templateObject_11ca5b20b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  */
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(CMSToken, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_11ca5b20b4c611eaada595ac6eca7bce());
      }
    }, {
      key: "tag",
      get: function get() {
