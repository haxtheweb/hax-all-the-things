define(["exports", "require", "../../lit-element/lit-element.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleModal) {
  ...
  function _templateObject3_ce6e37201b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "]);

    _templateObject3_ce6e37201b7311eab0b3b7b8d9dcf584 = function _templateObject3_ce6e37201b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_ce6e37201b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <editable-list-item\n              ?edit-mode=\"", "\"\n              ?can-edit=\"", "\"\n              ?can-delete=\"", "\"\n              value=\"", "\"\n            ></editable-list-item>\n          "]);

    _templateObject2_ce6e37201b7311eab0b3b7b8d9dcf584 = function _templateObject2_ce6e37201b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_ce6e37201b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"list\">\n        ", "\n      </div>\n    "]);

    _templateObject_ce6e37201b7311eab0b3b7b8d9dcf584 = function _templateObject_ce6e37201b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ce6e37201b7311eab0b3b7b8d9dcf584(), this.items.map(function (item) {
          return (0, _litElement.html)(_templateObject2_ce6e37201b7311eab0b3b7b8d9dcf584(), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_ce6e37201b7311eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "properties",
      get: function get() {
