define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_ae7561608a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-image\n        src=\"", "\"\n        preload=\"\"\n        fade=\"\"\n        sizing=\"cover\"\n        id=\"image\"\n      ></iron-image>\n      <div class=\"overlay\">\n        <h2 id=\"header\" ?hidden=\"", "\">", "</h2>\n        <div id=\"subheader\" ?hidden=\"", "\">", "</div>\n        <div id=\"body\">\n          <p ?hidden=\"", "\">", "</p>\n          <slot></slot>\n        </div>\n        <a\n          tabindex=\"-1\"\n          href=\"", "\"\n          id=\"actionlink\"\n          @click=\"", "\"\n        >\n          <paper-button raised=\"\" id=\"action\">\n            <span id=\"label\"\n              >", "<iron-icon\n                id=\"icon\"\n                icon=\"", "\"\n                ?hidden=\"", "\"\n              ></iron-icon\n            ></span>\n          </paper-button>\n        </a>\n      </div>\n    "]);

    _templateObject2_ae7561608a2611eaafc8a9b4dccb8bbb = function _templateObject2_ae7561608a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_ae7561608a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_ae7561608a2611eaafc8a9b4dccb8bbb = function _templateObject_ae7561608a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MagazineCover, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_ae7561608a2611eaafc8a9b4dccb8bbb())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(MagazineCover, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_ae7561608a2611eaafc8a9b4dccb8bbb(), this.image, !this.header, this.header, !this.subheader, this.subheader, !this.text, this.text, this.link, this._linkTapped, this.action, this.icon, !this.icon);
      }
      /**
       * convention
       */
