define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../utils/utils.js", "../../../mobx/lib/mobx.module.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _simpleColors, _haxcmsSiteStore, _utils, _mobxModule, _customStyle) {
  ...
  function _templateObject2_a4fd34b0147811ea8938179bdbdbf9a7() {
    ...
    _templateObject2_a4fd34b0147811ea8938179bdbdbf9a7 = function _templateObject2_a4fd34b0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function _templateObject_a4fd34b0147811ea8938179bdbdbf9a7() {
    ...
    _templateObject_a4fd34b0147811ea8938179bdbdbf9a7 = function _templateObject_a4fd34b0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleBlogFooter, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a4fd34b0147811ea8938179bdbdbf9a7(), this.manifest.metadata.theme.variables.image, this.nextChanged, this.nextTitle, this.prevChanged, this.prevTitle, this._backButtonTap, this.manifest.title, this.manifest.description);
      }
      /**
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleBlogFooter), "styles", this)), [(0, _litElement.css)(_templateObject2_a4fd34b0147811ea8938179bdbdbf9a7())]);
      }
      /**
    ...
    function SimpleBlogFooter() {
      ...
      (0, _mobxModule.autorun)(function (reaction) {
        ...
        if ((0, _utils.varExists)(_this.manifest, "title")) {
          document.title = _this.manifest.title;
        }

        if ((0, _utils.varExists)(_this.manifest, "metadata.theme.variables.cssVariable")) {
