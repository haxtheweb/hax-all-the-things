define(["exports", "../../lit-element/lit-element.js", "../cms-hax/cms-hax.js"], function (_exports, _litElement, _cmsHax) {
  ...
  function _templateObject2_2082f0f01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

    _templateObject2_2082f0f01b7411eab0b3b7b8d9dcf584 = function _templateObject2_2082f0f01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_2082f0f01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <textarea\n        class=\"", "\"\n        id=\"", "\"\n        name=\"", "\"\n        hidden=\"\"\n      >\n      ", "\n      </textarea\n      >\n      <cms-hax\n        hide-message=\"\"\n        redirect-location=\"", "\"\n        update-page-data=\"", "\"\n        end-point=\"", "\"\n        app-store-connection=\"", "\"\n        ?open-default=\"", "\"\n        ?sync-body=\"", "\"\n        ?hide-export-button=\"", "\"\n        ?hide-panel-ops=\"", "\"\n        ?hide-preferences-button=\"", "\"\n        align=\"", "\"\n      >\n      </cms-hax>\n    "]);

    _templateObject_2082f0f01b7411eab0b3b7b8d9dcf584 = function _templateObject_2082f0f01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(WysiwygHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2082f0f01b7411eab0b3b7b8d9dcf584(), this.fieldClass, this.fieldId, this.fieldName, this.bodyValue, this.redirectLocation, this.updatePageData, this.endPoint, this.appStoreConnection, this.openDefault, this.syncBody, this.hideExportButton, this.hidePanelOps, this.hidePreferencesButton, this.align);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_2082f0f01b7411eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "tag",
      get: function get() {
