define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../../@polymer/polymer/lib/elements/custom-style.js", "../../@polymer/app-layout/app-drawer/app-drawer.js", "../../@polymer/neon-animation/neon-animation.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/iron-icons/iron-icons.js", "../../@polymer/iron-icon/iron-icon.js"], function (_exports, _litElement, _simpleColors, _customStyle, _appDrawer, _neonAnimation, _paperButton, _ironIcons, _ironIcon) {
  ...
  function _templateObject3_b208c1508a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject3_b208c1508a2611eaafc8a9b4dccb8bbb = function _templateObject3_b208c1508a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b208c1508a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <h2>", "</h2>\n                "]);

    _templateObject2_b208c1508a2611eaafc8a9b4dccb8bbb = function _templateObject2_b208c1508a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b208c1508a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b208c1508a2611eaafc8a9b4dccb8bbb = function _templateObject_b208c1508a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(SimpleDrawer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b208c1508a2611eaafc8a9b4dccb8bbb(), this.opened, this.__openedChanged, this.align, this.title ? (0, _litElement.html)(_templateObject2_b208c1508a2611eaafc8a9b4dccb8bbb(), this.title) : "", this.close, this.closeIcon, this.closeLabel);
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleDrawer), "styles", this)), [(0, _litElement.css)(_templateObject3_b208c1508a2611eaafc8a9b4dccb8bbb())]);
      }
    }, {
      key: "properties",
      get: function get() {
