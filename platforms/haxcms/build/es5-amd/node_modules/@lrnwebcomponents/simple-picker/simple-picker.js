define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject5_755164a00a3e11eaa435db19266a448e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        option-", "-", "\n      "]);

    _templateObject5_755164a00a3e11eaa435db19266a448e = function _templateObject5_755164a00a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function _templateObject4_755164a00a3e11eaa435db19266a448e() {
    ...
    _templateObject4_755164a00a3e11eaa435db19266a448e = function _templateObject4_755164a00a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function _templateObject3_755164a00a3e11eaa435db19266a448e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                              <simple-picker-option\n                                @option-focus=\"", "\"\n                                @set-selected-option=\"", "\"\n                                ?active=\"", "\"\n                                ?hide-option-labels=\"", "\"\n                                ?hidden=\"", "\"\n                                ?selected=\"", "\"\n                                ?title-as-html=\"", "\"\n                                .data=\"", "\"\n                                .icon=\"", "\"\n                                .id=\"option-", "-", "\"\n                                .label=\"", "\"\n                                .style=", "\n                                aria-selected=\"", "\"\n                                role=\"option\"\n                                tabindex=\"-1\"\n                                value=\"", "\"\n                              >\n                              </simple-picker-option>\n                            "]);

    _templateObject3_755164a00a3e11eaa435db19266a448e = function _templateObject3_755164a00a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function _templateObject2_755164a00a3e11eaa435db19266a448e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <div class=\"row\">\n                      ", "\n                    </div>\n                  "]);

    _templateObject2_755164a00a3e11eaa435db19266a448e = function _templateObject2_755164a00a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function _templateObject_755164a00a3e11eaa435db19266a448e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <label\n        id=\"listLabel\"\n        for=\"listbox\"\n        .hidden=\"", "\"\n      >\n        ", "\n      </label>\n      <div\n        id=\"listbox\"\n        .aria-activedescendant=\"", "\"\n        .aria-labelledby=\"", "\"\n        .disabled=\"", "\"\n        role=\"listbox\"\n        tabindex=\"0\"\n        @click=\"", "\"\n        @mousedown=\"", "\"\n        @keydown=\"", "\"\n      >\n        <div id=\"sample\">\n          <simple-picker-option\n            ?hide-option-labels=\"", "\"\n            ?title-as-html=\"", "\"\n            .icon=\"", "\"\n            .label=\"", "\"\n            .style=", "\n            aria-hidden=\"true\"\n          >\n          </simple-picker-option>\n          <span id=\"icon\"\n            ><iron-icon aria-hidden=\"true\" icon=\"arrow-drop-down\"></iron-icon\n          ></span>\n        </div>\n        <div id=\"collapse\">\n          <div class=\"rows\">\n            ", "\n          </div>\n        </div>\n      </div>\n    "]);

    _templateObject_755164a00a3e11eaa435db19266a448e = function _templateObject_755164a00a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePicker, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_755164a00a3e11eaa435db19266a448e(), !this.label || this.label.trim() === "", this.label && this.label.trim() !== "" ? this.label.trim() : "", this.__activeDesc, this.ariaLabelledby, this.disabled, this._handleListboxClick, this._handleListboxMousedown, this._handleListboxKeydown, this.hideOptionLabels, this.titleAsHtml, this.__selectedOption ? this.__selectedOption.icon : false, this.__selectedOption ? this.__selectedOption.alt : false, this.__selectedOption ? this.__selectedOption.style : false, this.__options ? this.__options.map(function (row, rownum) {
          return (0, _litElement.html)(_templateObject2_755164a00a3e11eaa435db19266a448e(), row ? row.map(function (option, colnum) {
            return (0, _litElement.html)(_templateObject3_755164a00a3e11eaa435db19266a448e(), _this2._handleOptionFocus, _this2._handleSetSelectedOption, "".concat(_this2.__activeDesc) === "option-".concat(rownum, "-").concat(colnum), _this2.hideOptionLabels, !_this2.allowNull && !option.value, _this2.value === option.value, _this2.titleAsHtml, _this2.data, option.icon, rownum, colnum, option.alt, option.style, _this2.value === option.value ? "true" : "false", option.value);
          }) : "");
        }) : "");
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_755164a00a3e11eaa435db19266a448e())];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimplePicker, [{
      ...
      value: function _goToOption(rownum, colnum) {
        var targetId = (0, _litElement.html)(_templateObject5_755164a00a3e11eaa435db19266a448e(), rownum, colnum),
