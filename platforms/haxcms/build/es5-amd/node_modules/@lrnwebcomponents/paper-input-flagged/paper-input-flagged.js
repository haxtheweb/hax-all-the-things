define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_b0b391908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-input\n        label=\"", "\"\n        value=\"", "\"\n        @value-changed=\"", "\"\n        ?char-counter=\"", "\"\n        ?disabled=\"", "\"\n        minlength=\"", "\"\n        maxlength=\"", "\"\n      >\n        <iron-icon id=\"icon\" icon=\"", "\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      <div class=\"element-invisible\">", "</div>\n      <simple-tooltip\n        for=\"icon\"\n        position=\"top\"\n        offset=\"20\"\n        fit-to-visible-bounds\n      >\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject2_b0b391908a2611eaafc8a9b4dccb8bbb = function _templateObject2_b0b391908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b0b391908a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b0b391908a2611eaafc8a9b4dccb8bbb = function _templateObject_b0b391908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  */
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(PaperInputFlagged, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_b0b391908a2611eaafc8a9b4dccb8bbb())];
      }
    }]);
    ...
    babelHelpers.createClass(PaperInputFlagged, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_b0b391908a2611eaafc8a9b4dccb8bbb(), this.label, this.value, this.valueEvent, this.charCounter, this.disabled, this.minlength, this.maxlength, this.icon, this.__activeMessage, this.__activeMessage);
      }
    }, {
      key: "testStatus",
