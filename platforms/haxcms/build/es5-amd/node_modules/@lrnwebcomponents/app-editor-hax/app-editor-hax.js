define(["exports", "../../lit-element/lit-element.js", "../h-a-x/h-a-x.js"], function (_exports, _litElement, _hAX) {
  ...
  function _templateObject2_9591c4908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_9591c4908a2611eaafc8a9b4dccb8bbb = function _templateObject2_9591c4908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_9591c4908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h-a-x .app-store=\"", "\"></h-a-x>\n    "]);

    _templateObject_9591c4908a2611eaafc8a9b4dccb8bbb = function _templateObject_9591c4908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(AppEditorHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_9591c4908a2611eaafc8a9b4dccb8bbb(), this.appStoreConnection);
      }
    }, {
      key: "save",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_9591c4908a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "tag",
      get: function get() {
