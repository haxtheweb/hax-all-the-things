define(["exports", "../../../lit-element/lit-element.js", "./relative-heading-state-manager.js"], function (_exports, _litElement, _relativeHeadingStateManager) {
  ...
  function _templateObject2_ba3754408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n      "]);

    _templateObject2_ba3754408a2611eaafc8a9b4dccb8bbb = function _templateObject2_ba3754408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_ba3754408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);

    _templateObject_ba3754408a2611eaafc8a9b4dccb8bbb = function _templateObject_ba3754408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(RelativeHeadingLite, [{
      ...
      key: "template",
      get: function get() {
        return (0, _litElement.html)(_templateObject_ba3754408a2611eaafc8a9b4dccb8bbb());
      }
      /**
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_ba3754408a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
