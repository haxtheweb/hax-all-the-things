define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_ba3e0b008a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        simple-toast:not(:defined) {\n          display: none;\n        }\n      "]);

    _templateObject2_ba3e0b008a2611eaafc8a9b4dccb8bbb = function _templateObject2_ba3e0b008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_ba3e0b008a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-toast\n        id=\"relative-heading-toast\"\n        duration=\"5000\"\n        ?hidden=\"", "\"\n        ?disabled=\"", "\"\n        text=\"", ": ", "\"\n      >\n        <paper-icon-button\n          icon=\"", "\"\n          label=\"", "\"\n          title=\"", "\"\n          @click=\"", "\"\n        ></paper-icon-button>\n      </simple-toast>\n    "]);

    _templateObject_ba3e0b008a2611eaafc8a9b4dccb8bbb = function _templateObject_ba3e0b008a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(RelativeHeadingStateManager, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ba3e0b008a2611eaafc8a9b4dccb8bbb(), !this.usesCopyLink, !this.usesCopyLink, this.copyHeading.copyMessage || this.copyMessage, this.copyUrl, this.copyHeading.closeIcon || this.closeIcon, this.copyHeading.closeLabel || this.closeLabel, this.copyHeading.closeLabel || this.closeLabel, this.closeCopyLink);
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_ba3e0b008a2611eaafc8a9b4dccb8bbb())];
      }
    }]);
