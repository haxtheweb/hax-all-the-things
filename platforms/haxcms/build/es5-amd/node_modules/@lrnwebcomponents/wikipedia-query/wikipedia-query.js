define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _require, _litElement, _ironAjax) {
  ...
  function _templateObject3_1153f2a0b4c611eaada595ac6eca7bce() {
    ...
    _templateObject3_1153f2a0b4c611eaada595ac6eca7bce = function _templateObject3_1153f2a0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject2_1153f2a0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "]);

    _templateObject2_1153f2a0b4c611eaada595ac6eca7bce = function _templateObject2_1153f2a0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_1153f2a0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          --wikipedia-query-body-height: 160px;\n        }\n        :host [hidden] {\n          display: none;\n        }\n        #result {\n          height: var(--wikipedia-query-body-height);\n          overflow: scroll;\n          border: 1px grey solid;\n          padding: 8px 16px;\n        }\n        citation-element {\n          background-color: #f8f8f8;\n          padding: 16px 8px;\n          font-size: 12px;\n        }\n      "]);

    _templateObject_1153f2a0b4c611eaada595ac6eca7bce = function _templateObject_1153f2a0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(WikipediaQuery, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_1153f2a0b4c611eaada595ac6eca7bce())];
      }
    }]);
    ...
    babelHelpers.createClass(WikipediaQuery, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_1153f2a0b4c611eaada595ac6eca7bce(), this.search ? (0, _litElement.html)(_templateObject3_1153f2a0b4c611eaada595ac6eca7bce(), this.search, this.handleResponse, this.searchResponseChanged, this.hideTitle, this._title, this.search, this.search, this.__now) : "");
      }
    }, {
