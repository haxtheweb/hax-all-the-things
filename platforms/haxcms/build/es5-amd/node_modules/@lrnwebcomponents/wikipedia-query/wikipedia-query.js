define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _require, _litElement, _ironAjax) {
  ...
  function _templateObject3_b34deb808a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject3_b34deb808a2611eaafc8a9b4dccb8bbb = function _templateObject3_b34deb808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b34deb808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n    "]);

    _templateObject2_b34deb808a2611eaafc8a9b4dccb8bbb = function _templateObject2_b34deb808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b34deb808a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          --wikipedia-query-body-height: 160px;\n        }\n        :host [hidden] {\n          display: none;\n        }\n        #result {\n          height: var(--wikipedia-query-body-height);\n          overflow: scroll;\n          border: 1px grey solid;\n          padding: 8px 16px;\n        }\n        citation-element {\n          background-color: #f8f8f8;\n          padding: 16px 8px;\n          font-size: 12px;\n        }\n      "]);

    _templateObject_b34deb808a2611eaafc8a9b4dccb8bbb = function _templateObject_b34deb808a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(WikipediaQuery, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_b34deb808a2611eaafc8a9b4dccb8bbb())];
      }
    }]);
    ...
    babelHelpers.createClass(WikipediaQuery, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_b34deb808a2611eaafc8a9b4dccb8bbb(), this.search ? (0, _litElement.html)(_templateObject3_b34deb808a2611eaafc8a9b4dccb8bbb(), this.search, this.handleResponse, this.searchResponseChanged, this.hideTitle, this._title, this.search, this.search, this.__now) : "");
      }
    }, {
