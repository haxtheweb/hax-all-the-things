define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _require, _litElement, _ironAjax) {
  ...
  function _templateObject2_1fc6a5d01b7411eab0b3b7b8d9dcf584() {
    ...
    _templateObject2_1fc6a5d01b7411eab0b3b7b8d9dcf584 = function _templateObject2_1fc6a5d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_1fc6a5d01b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          --wikipedia-query-body-height: 160px;\n        }\n        :host [hidden] {\n          display: none;\n        }\n        #result {\n          height: var(--wikipedia-query-body-height);\n          overflow: scroll;\n          border: 1px grey solid;\n          padding: 8px 16px;\n        }\n        citation-element {\n          background-color: #f8f8f8;\n          padding: 16px 8px;\n          font-size: 12px;\n        }\n      "]);

    _templateObject_1fc6a5d01b7411eab0b3b7b8d9dcf584 = function _templateObject_1fc6a5d01b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(WikipediaQuery, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_1fc6a5d01b7411eab0b3b7b8d9dcf584())];
      }
    }]);
    ...
    babelHelpers.createClass(WikipediaQuery, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_1fc6a5d01b7411eab0b3b7b8d9dcf584(), this.search, this.handleResponse, this.searchResponseChanged, this.hideTitle, this._title, !this.__rendercontent, !this.__rendercontent, this.search, this.search, this.__now);
      }
    }, {
