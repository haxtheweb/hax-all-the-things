define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_e55c6600229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <app-toolbar>\n        <lrnsys-button\n          alt=\"Zoom in\"\n          icon=\"zoom-in\"\n          @click=\"", "\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <lrnsys-button\n          alt=\"Zoom out\"\n          icon=\"zoom-out\"\n          @click=\"", "\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <lrnsys-button\n          alt=\"Rotate right\"\n          icon=\"image:rotate-right\"\n          @click=\"", "\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <lrnsys-button\n          alt=\"Rotate left\"\n          icon=\"image:rotate-left\"\n          @click=\"", "\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <lrnsys-button\n          alt=\"Mirror image\"\n          icon=\"image:flip\"\n          @click=\"", "\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <lrnsys-button\n          alt=\"Open in new window\"\n          icon=\"launch\"\n          href=\"", "\"\n          target=\"_blank\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <lrnsys-button\n          alt=\"EXIF Data\"\n          icon=\"image:camera-roll\"\n          @click=\"", "\"\n          hover-class=\"", "\"\n        ></lrnsys-button>\n        <slot name=\"toolbar\"></slot>\n      </app-toolbar>\n      <exif-data id=\"exif\" @click=", " no-events>\n        <img src=\"", "\" />\n      </exif-data>\n      <img-pan-zoom id=\"img\" src=\"", "\"></img-pan-zoom>\n      <slot></slot>\n    "]);

    _templateObject2_e55c6600229911ea85c7378a1f0d905a = function _templateObject2_e55c6600229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject_e55c6600229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          overflow: hidden;\n          --image-inspector-background: #dddddd;\n        }\n\n        app-toolbar {\n          width: 90%;\n          background: var(--image-inspector-background);\n          margin: 0 auto;\n          padding: 0;\n          z-index: 1;\n          display: flex;\n          text-align: center;\n          justify-content: space-evenly;\n        }\n\n        lrnsys-button {\n          display: inline-flex;\n        }\n\n        .top {\n          top: 128px;\n        }\n        .showData {\n          display: block;\n          z-index: 2;\n        }\n        exif-data {\n          margin: 0 auto;\n          justify-content: space-evenly;\n          position: absolute;\n          display: none;\n          margin: 0;\n          padding: 0;\n        }\n        exif-data img {\n          margin: 0;\n          opacity: 0;\n          padding: 0;\n          height: 500px;\n          pointer-events: none;\n        }\n      "]);

    _templateObject_e55c6600229911ea85c7378a1f0d905a = function _templateObject_e55c6600229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ImageInspector, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_e55c6600229911ea85c7378a1f0d905a())];
      }
    }]);
    ...
    babelHelpers.createClass(ImageInspector, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_e55c6600229911ea85c7378a1f0d905a(), this.zoomIn, this.hoverClass, this.zoomOut, this.hoverClass, this.rotateRight, this.hoverClass, this.rotateLeft, this.hoverClass, this.mirrorImage, this.hoverClass, this.src, this.hoverClass, this.exifDataEvent, this.hoverClass, this.hideData, this.src, this.src);
      }
    }, {
      key: "exifDataEvent",
