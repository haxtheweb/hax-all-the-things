define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _polymerElement, _schemaBehaviors) {
  ...
  function _templateObject_f8f61fd01b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        .hidden-title {\n          display: none;\n        }\n      </style>\n      <div typeof=\"oer:SupportingMaterial\">\n        <div class=\"hidden-title\" property=\"oer:name\">[[title]]</div>\n        <div property=\"oer:description\">\n          <slot></slot>\n          <csv-render\n            data-source=\"[[csvFile]]\"\n            caption=\"[[title]]\"\n            summary=\"[[description]]\"\n          ></csv-render>\n        </div>\n      </div>\n    "]);

    _templateObject_f8f61fd01b7311eab0b3b7b8d9dcf584 = function _templateObject_f8f61fd01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnTable, null, [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_f8f61fd01b7311eab0b3b7b8d9dcf584());
      }
    }, {
      key: "tag",
      get: function get() {
