define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _polymerElement, _renderStatus, _HAXWiring, _schemaBehaviors) {
  ...
  function _templateObject_3227cee0b53311e9a29de1791e382d63() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        .hidden-title {\n          display: none;\n        }\n      </style>\n      <div typeof=\"oer:SupportingMaterial\">\n        <div class=\"hidden-title\" property=\"oer:name\">[[title]]</div>\n        <div property=\"oer:description\">\n          <slot></slot>\n          <csv-render\n            data-source=\"[[csvFile]]\"\n            caption=\"[[title]]\"\n            summary=\"[[description]]\"\n          ></csv-render>\n        </div>\n      </div>\n    "]);

    _templateObject_3227cee0b53311e9a29de1791e382d63 = function _templateObject_3227cee0b53311e9a29de1791e382d63() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnTable, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_3227cee0b53311e9a29de1791e382d63());
      }
    }, {
      key: "tag",
      get: function get() {
