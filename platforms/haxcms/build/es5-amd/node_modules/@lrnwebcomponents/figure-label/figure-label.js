define(["exports", "../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject2_9e38bbd08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #wrap {\n          display: flex;\n          margin-bottom: 1em;\n        }\n\n        #title {\n          background-color: #f2f2f2;\n          padding: 10.8px 13.5px 10.8px;\n          font-size: 13.5px;\n        }\n\n        #description {\n          border: solid 1px #f2f2f2;\n          padding: 10.8px 13.5px 10.8px;\n          font-size: 13.5px;\n        }\n      "]);

    _templateObject2_9e38bbd08a2611eaafc8a9b4dccb8bbb = function _templateObject2_9e38bbd08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_9e38bbd08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"wrap\">\n        <div id=\"title\">", "</div>\n        <div id=\"description\">", "</div>\n      </div>\n    "]);

    _templateObject_9e38bbd08a2611eaafc8a9b4dccb8bbb = function _templateObject_9e38bbd08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(FigureLabel, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_9e38bbd08a2611eaafc8a9b4dccb8bbb(), this.title, this.description);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_9e38bbd08a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
