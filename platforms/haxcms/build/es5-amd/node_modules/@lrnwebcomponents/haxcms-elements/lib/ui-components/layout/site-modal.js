define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../../simple-modal/lib/simple-modal-template.js", "../../../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _flattenedNodesObserver, _simpleModalTemplate, _paperIconButton, _customStyle) {
  ...
  function _templateObject2_4b7d4a801b7411eab0b3b7b8d9dcf584() {
    ...
    _templateObject2_4b7d4a801b7411eab0b3b7b8d9dcf584 = function _templateObject2_4b7d4a801b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_4b7d4a801b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        paper-icon-button {\n          color: var(--site-modal-icon-color);\n        }\n      "]);

    _templateObject_4b7d4a801b7411eab0b3b7b8d9dcf584 = function _templateObject_4b7d4a801b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteModal, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_4b7d4a801b7411eab0b3b7b8d9dcf584())];
      }
      /**
    ...
    babelHelpers.createClass(SiteModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_4b7d4a801b7411eab0b3b7b8d9dcf584(), this.editMode, this.fireEvent, this.icon, this.buttonLabel, this.position, this.buttonLabel, this.title);
      }
      /**
