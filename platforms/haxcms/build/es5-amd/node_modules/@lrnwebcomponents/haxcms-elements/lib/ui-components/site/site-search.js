define(["exports", "require", "../../../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject5_c5a693408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <a class=\"result\" .href=\"", "\">\n            <div class=\"title\">\n              ", "<span class=\"link-text\" aria-hidden=\"true\"\n                >(", ")</span\n              >\n            </div>\n            <div class=\"date\">\n              <simple-datetime format=\"M jS\" .timestamp=\"", "\" unix\n                >", "</simple-datetime\n              >\n            </div>\n            <p>", "..</p>\n          </a>\n        "]);

    _templateObject5_c5a693408a2611eaafc8a9b4dccb8bbb = function _templateObject5_c5a693408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject4_c5a693408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_c5a693408a2611eaafc8a9b4dccb8bbb = function _templateObject4_c5a693408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_c5a693408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            Found ", " results.\n          "]);

    _templateObject3_c5a693408a2611eaafc8a9b4dccb8bbb = function _templateObject3_c5a693408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_c5a693408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-input\n        id=\"search\"\n        always-float-label\n        label=\"Search\"\n        @value-changed=\"", "\"\n      >\n        <iron-icon icon=\"search\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      ", "\n      <lunr-search id=\"lunr\"></lunr-search>\n\n      ", "\n    "]);

    _templateObject2_c5a693408a2611eaafc8a9b4dccb8bbb = function _templateObject2_c5a693408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_c5a693408a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_c5a693408a2611eaafc8a9b4dccb8bbb = function _templateObject_c5a693408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteSearch, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_c5a693408a2611eaafc8a9b4dccb8bbb())];
      }
      /**
    ...
    babelHelpers.createClass(SiteSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_c5a693408a2611eaafc8a9b4dccb8bbb(), this._searchValueChanged, this.search.length > 0 ? (0, _litElement.html)(_templateObject3_c5a693408a2611eaafc8a9b4dccb8bbb(), this.__results.length) : (0, _litElement.html)(_templateObject4_c5a693408a2611eaafc8a9b4dccb8bbb()), this.__results.map(function (item) {
          return (0, _litElement.html)(_templateObject5_c5a693408a2611eaafc8a9b4dccb8bbb(), item.location, item.title, item.location, item.created, item.created, item.description);
        }));
      }
    }, {
