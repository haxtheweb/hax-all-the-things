define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _customStyle) {
  ...
  function _templateObject5_d32575a0147811ea8938179bdbdbf9a7() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <a class=\"result\" .href=\"", "\">\n            <div class=\"title\">\n              ", "<span class=\"link-text\" aria-hidden=\"true\"\n                >(", ")</span\n              >\n            </div>\n            <div class=\"date\">\n              <simple-datetime format=\"M jS\" .timestamp=\"", "\" unix\n                >", "</simple-datetime\n              >\n            </div>\n            <p>", "..</p>\n          </a>\n        "]);

    _templateObject5_d32575a0147811ea8938179bdbdbf9a7 = function _templateObject5_d32575a0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function _templateObject4_d32575a0147811ea8938179bdbdbf9a7() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_d32575a0147811ea8938179bdbdbf9a7 = function _templateObject4_d32575a0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function _templateObject3_d32575a0147811ea8938179bdbdbf9a7() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            Found ", " results.\n          "]);

    _templateObject3_d32575a0147811ea8938179bdbdbf9a7 = function _templateObject3_d32575a0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function _templateObject2_d32575a0147811ea8938179bdbdbf9a7() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          .result {\n            @apply --site-search-result;\n          }\n          .result:hover,\n          .result:focus {\n            @apply --site-search-result-hover;\n          }\n          .result .title {\n            @apply --site-search-link-text;\n          }\n          .result .link-text {\n            @apply --site-search-link-text;\n          }\n        </style>\n      </custom-style>\n      <paper-input\n        id=\"search\"\n        always-float-label\n        label=\"Search\"\n        @value-changed=\"", "\"\n      >\n        <iron-icon icon=\"search\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      ", "\n      <lunr-search id=\"lunr\"></lunr-search>\n\n      ", "\n    "]);

    _templateObject2_d32575a0147811ea8938179bdbdbf9a7 = function _templateObject2_d32575a0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function _templateObject_d32575a0147811ea8938179bdbdbf9a7() {
    ...
    _templateObject_d32575a0147811ea8938179bdbdbf9a7 = function _templateObject_d32575a0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteSearch, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_d32575a0147811ea8938179bdbdbf9a7())];
      }
      /**
    ...
    babelHelpers.createClass(SiteSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_d32575a0147811ea8938179bdbdbf9a7(), this._searchValueChanged, this.search.length > 0 ? (0, _litElement.html)(_templateObject3_d32575a0147811ea8938179bdbdbf9a7(), this.__results.length) : (0, _litElement.html)(_templateObject4_d32575a0147811ea8938179bdbdbf9a7()), this.__results.map(function (item) {
          return (0, _litElement.html)(_templateObject5_d32575a0147811ea8938179bdbdbf9a7(), item.location, item.title, item.location, item.created, item.created, item.description);
        }));
      }
    }, {
