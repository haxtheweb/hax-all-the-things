define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/paper-styles/shadow.js", "../../../../../@polymer/paper-styles/typography.js", "../../../../../@polymer/paper-styles/color.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _shadow, _typography, _color, _customStyle) {
  ...
  function _templateObject2_c1e0ffc08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject2_c1e0ffc08a2611eaafc8a9b4dccb8bbb = function _templateObject2_c1e0ffc08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_c1e0ffc08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_c1e0ffc08a2611eaafc8a9b4dccb8bbb = function _templateObject_c1e0ffc08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteLogin, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_c1e0ffc08a2611eaafc8a9b4dccb8bbb())];
      }
      /**
    ...
    babelHelpers.createClass(SiteLogin, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_c1e0ffc08a2611eaafc8a9b4dccb8bbb(), !this.loading, this.title, this.subtitle, this.errorMsg, this.username, this.usernameChanged, this.loading, this.userInputLabel, this.userInputErrMsg, this.password, this.passwordChanged, this.loading, this.passwordInputLabel, this.passwordInputErrMsg, this._login, this.loading, this.loginBtnText);
      }
    }, {
      key: "usernameChanged",
