define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxModule, _customStyle) {
  ...
  function _templateObject2_cef3d9e0147811ea8938179bdbdbf9a7() {
    ...
    _templateObject2_cef3d9e0147811ea8938179bdbdbf9a7 = function _templateObject2_cef3d9e0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function _templateObject_cef3d9e0147811ea8938179bdbdbf9a7() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          transition: 0.3s all ease-in-out;\n        }\n        :host([disabled]) {\n          pointer-events: none;\n          opacity: 0.3;\n        }\n        a {\n          color: black;\n          text-decoration: underline;\n        }\n        paper-button {\n          transition: 0.3s all ease-in-out;\n          min-width: unset;\n        }\n        iron-icon {\n          display: block;\n          font-size: 16px;\n        }\n      "]);

    _templateObject_cef3d9e0147811ea8938179bdbdbf9a7 = function _templateObject_cef3d9e0147811ea8938179bdbdbf9a7() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteMenuButton, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_cef3d9e0147811ea8938179bdbdbf9a7())];
      }
      /**
    ...
    babelHelpers.createClass(SiteMenuButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_cef3d9e0147811ea8938179bdbdbf9a7(), this.disabled, this.label, this.disabled, this.raised, this.label, this.icon, this.position, this.label);
      }
      /**
       * Props
       */
