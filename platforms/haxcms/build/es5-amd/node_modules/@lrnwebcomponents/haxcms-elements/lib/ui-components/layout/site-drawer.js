define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _customStyle) {
  ...
  function _templateObject2_9db164400a3e11eaa435db19266a448e() {
    ...
    _templateObject2_9db164400a3e11eaa435db19266a448e = function _templateObject2_9db164400a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function _templateObject_9db164400a3e11eaa435db19266a448e() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        .drawer-contents {\n          height: 100%;\n          overflow-y: auto;\n          padding: 16px;\n        }\n        paper-icon-button {\n          color: var(--site-drawer-button-color, #ffffff);\n        }\n      "]);

    _templateObject_9db164400a3e11eaa435db19266a448e = function _templateObject_9db164400a3e11eaa435db19266a448e() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteDrawer, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_9db164400a3e11eaa435db19266a448e())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(SiteDrawer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_9db164400a3e11eaa435db19266a448e(), this.icon, this.toggle, this.align);
      }
    }, {
      key: "toggle",
