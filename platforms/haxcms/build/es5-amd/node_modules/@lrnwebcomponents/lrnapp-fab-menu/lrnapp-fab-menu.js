define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_a977c3108a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject2_a977c3108a2611eaafc8a9b4dccb8bbb = function _templateObject2_a977c3108a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_a977c3108a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-fab\n        icon=\"", "\"\n        class=\"open\"\n        @click=\"", "\"\n        ?hidden=\"", "\"\n        ?disabled=\"", "\"\n      ></paper-fab>\n\n      <paper-fab-speed-dial-overlay\n        class=\"overlay\"\n        ?opened=\"", "\"\n        @opened-changed=\"", "\"\n        with-backdrop\n      >\n        <slot></slot>\n        <paper-fab\n          icon=\"close\"\n          class=\"close\"\n          @click=\"", "\"\n        ></paper-fab>\n      </paper-fab-speed-dial-overlay>\n    "]);

    _templateObject_a977c3108a2611eaafc8a9b4dccb8bbb = function _templateObject_a977c3108a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappFabMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a977c3108a2611eaafc8a9b4dccb8bbb(), this.icon, this.open, this.opened, this.disabled, this.opened, this.openedChangedEvent, this.close);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_a977c3108a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "tag",
      get: function get() {
