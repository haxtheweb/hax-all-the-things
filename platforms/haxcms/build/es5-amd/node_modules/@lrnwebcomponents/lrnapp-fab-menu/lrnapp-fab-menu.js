define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_0b4b25e0b4c611eaada595ac6eca7bce() {
    ...
    _templateObject2_0b4b25e0b4c611eaada595ac6eca7bce = function _templateObject2_0b4b25e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_0b4b25e0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-fab\n        icon=\"", "\"\n        class=\"open\"\n        @click=\"", "\"\n        ?hidden=\"", "\"\n        ?disabled=\"", "\"\n      ></paper-fab>\n\n      <paper-fab-speed-dial-overlay\n        class=\"overlay\"\n        ?opened=\"", "\"\n        @opened-changed=\"", "\"\n        with-backdrop\n      >\n        <slot></slot>\n        <paper-fab\n          icon=\"close\"\n          class=\"close\"\n          @click=\"", "\"\n        ></paper-fab>\n      </paper-fab-speed-dial-overlay>\n    "]);

    _templateObject_0b4b25e0b4c611eaada595ac6eca7bce = function _templateObject_0b4b25e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappFabMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0b4b25e0b4c611eaada595ac6eca7bce(), this.icon, this.open, this.opened, this.disabled, this.opened, this.openedChangedEvent, this.close);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0b4b25e0b4c611eaada595ac6eca7bce())];
      }
    }, {
      key: "tag",
      get: function get() {
