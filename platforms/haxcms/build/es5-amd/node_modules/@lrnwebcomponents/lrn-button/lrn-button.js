define(["exports", "require", "../../lit-element/lit-element.js", "../materializecss-styles/lib/colors.js"], function (_exports, _require, _litElement, _colors) {
  ...
  function _templateObject4_a70479208a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject4_a70479208a2611eaafc8a9b4dccb8bbb = function _templateObject4_a70479208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_a70479208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <span class=\"label\">\n                    ", "\n                  </span>\n                "]);

    _templateObject3_a70479208a2611eaafc8a9b4dccb8bbb = function _templateObject3_a70479208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_a70479208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <iron-icon\n                    icon=\"", "\"\n                    id=\"icon\"\n                    class=\"", "\"\n                  ></iron-icon>\n                "]);

    _templateObject2_a70479208a2611eaafc8a9b4dccb8bbb = function _templateObject2_a70479208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_a70479208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <a\n        tabindex=\"-1\"\n        id=\"lrnsys-button-link\"\n        href=\"", "\"\n        data-prefetch-hover=\"", "\"\n        target=\"", "\"\n      >\n        <paper-button\n          id=\"button\"\n          raised=\"", "\"\n          class=\"", " ", " ", "\"\n          ?disabled=\"", "\"\n        >\n          <div class=\"inner ", "\">\n            ", "\n            ", "\n            <slot></slot>\n          </div>\n        </paper-button>\n      </a>\n      <simple-tooltip for=\"lrnsys-button-link\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject_a70479208a2611eaafc8a9b4dccb8bbb = function _templateObject_a70479208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a70479208a2611eaafc8a9b4dccb8bbb(), this.showHref, this.prefetch, this.target, this.raised, this.class, this.color, this.textColor, this.disabled, this.innerClass, this.icon ? (0, _litElement.html)(_templateObject2_a70479208a2611eaafc8a9b4dccb8bbb(), this.icon, this.iconClass) : "", this.label ? (0, _litElement.html)(_templateObject3_a70479208a2611eaafc8a9b4dccb8bbb(), this.label) : "", this.alt);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_a70479208a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
