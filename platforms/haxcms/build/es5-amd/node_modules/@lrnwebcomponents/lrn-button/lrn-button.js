define(["exports", "require", "../../lit-element/lit-element.js", "../materializecss-styles/materializecss-styles.js"], function (_exports, _require, _litElement, _materializecssStyles) {
  ...
  function _templateObject4_f64928401b7311eab0b3b7b8d9dcf584() {
    ...
    _templateObject4_f64928401b7311eab0b3b7b8d9dcf584 = function _templateObject4_f64928401b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject3_f64928401b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <span class=\"label\">\n                    ", "\n                  </span>\n                "]);

    _templateObject3_f64928401b7311eab0b3b7b8d9dcf584 = function _templateObject3_f64928401b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_f64928401b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <iron-icon\n                    icon=\"", "\"\n                    id=\"icon\"\n                    class=\"", "\"\n                  ></iron-icon>\n                "]);

    _templateObject2_f64928401b7311eab0b3b7b8d9dcf584 = function _templateObject2_f64928401b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_f64928401b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style include=\"materializecss-styles-colors\">\n          :host {\n            @apply --paper-button;\n          }\n        </style>\n      </custom-style>\n      <a\n        tabindex=\"-1\"\n        id=\"lrnsys-button-link\"\n        href=\"", "\"\n        data-prefetch-hover=\"", "\"\n        target=\"", "\"\n      >\n        <paper-button\n          id=\"button\"\n          raised=\"", "\"\n          class=\"", " ", " ", "\"\n          ?disabled=\"", "\"\n        >\n          <div class=\"inner ", "\">\n            ", "\n            ", "\n            <slot></slot>\n          </div>\n        </paper-button>\n      </a>\n      <paper-tooltip for=\"lrnsys-button-link\" animation-delay=\"0\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject_f64928401b7311eab0b3b7b8d9dcf584 = function _templateObject_f64928401b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_f64928401b7311eab0b3b7b8d9dcf584(), this.showHref, this.prefetch, this.target, this.raised, this.class, this.color, this.textColor, this.disabled, this.innerClass, this.icon ? (0, _litElement.html)(_templateObject2_f64928401b7311eab0b3b7b8d9dcf584(), this.icon, this.iconClass) : "", this.label ? (0, _litElement.html)(_templateObject3_f64928401b7311eab0b3b7b8d9dcf584(), this.label) : "", this.alt);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_f64928401b7311eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "properties",
      get: function get() {
