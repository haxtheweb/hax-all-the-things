define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _lrndesignGalleryZoom, _lrndesignGalleryDetails) {
  ...
  function _templateObject3_b67b36a08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-zoom\n                id=\"", "\"\n                details=\"", "\"\n                heading=\"", "\"\n                src=\"", "\"\n                tooltip=\"", "\"\n                zoom-alt=\"", "\"\n              >\n                <iron-image\n                  alt=\"", "\"\n                  fade\n                  sizing=\"cover\"\n                  src=\"", "\"\n                  style=\"", "\"\n                >\n                </iron-image>\n                <div class=\"zoombg\"></div>\n                <iron-icon icon=\"zoom-in\" class=\"zoomicon\"></iron-icon>\n              </lrndesign-gallery-zoom>\n              <simple-tooltip\n                for=\"", "\"\n                position=\"bottom\"\n                controls=\"zoomtpl\"\n                >", "</simple-tooltip\n              >\n            "]);

    _templateObject3_b67b36a08a2611eaafc8a9b4dccb8bbb = function _templateObject3_b67b36a08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b67b36a08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <article id=\"grid\">\n        <h1 id=\"gallerytitle\" ?hidden=\"", "\">\n          ", "\n        </h1>\n        <div id=\"gallery-description\"><slot></slot></div>\n        <p class=\"sr-only\">A list of thumbnail buttons items:</p>\n        <div id=\"galleryscreen\">\n          ", "\n        </div>\n        ", "\n      </article>\n    "]);

    _templateObject2_b67b36a08a2611eaafc8a9b4dccb8bbb = function _templateObject2_b67b36a08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b67b36a08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b67b36a08a2611eaafc8a9b4dccb8bbb = function _templateObject_b67b36a08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryGrid, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryGrid), "styles", this)), [(0, _litElement.css)(_templateObject_b67b36a08a2611eaafc8a9b4dccb8bbb())]);
    ...
    babelHelpers.createClass(LrndesignGalleryGrid, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_b67b36a08a2611eaafc8a9b4dccb8bbb(), this.galleryTitle, this.galleryTitle, this.sources.map(function (item) {
          return (0, _litElement.html)(_templateObject3_b67b36a08a2611eaafc8a9b4dccb8bbb(), item.id, item.details, item.heading, item.large, item.tooltip, item.zoomAlt, item.zoomAlt, item.thumbnail, _this2.imageStyle, item.id, item.tooltip);
        }), this.galleryPrint);
      }
      /**
