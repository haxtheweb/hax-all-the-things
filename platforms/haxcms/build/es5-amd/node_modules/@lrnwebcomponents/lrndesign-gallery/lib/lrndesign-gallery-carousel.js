define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "../../../@polymer/iron-image/iron-image.js", "../../../@polymer/iron-icons/iron-icons.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _ironImage, _ironIcons, _lrndesignGalleryZoom, _lrndesignGalleryDetails) {
  ...
  function _templateObject3_b673bc908a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject3_b673bc908a2611eaafc8a9b4dccb8bbb = function _templateObject3_b673bc908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b673bc908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          <button\n                            id=\"", "\"\n                            aria-controls=\"carousel\"\n                            class=\"gallerythumb\"\n                            index=\"", "\"\n                            style=\"--lrndesign-gallery-thumb-url:url('", "')\"\n                            @click=\"", "\"\n                            ?disabled=\"", "\"\n                          >\n                            <span class=\"sr-only\">", "</span>\n                          </button>\n                          <simple-tooltip\n                            for=\"", "\"\n                            ?hidden=\"", "\"\n                            position=\"top\"\n                          >\n                            ", "\n                          </simple-tooltip>\n                        "]);

    _templateObject2_b673bc908a2611eaafc8a9b4dccb8bbb = function _templateObject2_b673bc908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b673bc908a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b673bc908a2611eaafc8a9b4dccb8bbb = function _templateObject_b673bc908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryCarousel, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_b673bc908a2611eaafc8a9b4dccb8bbb(), this.galleryTitle, this.galleryTitle, this.aspectRatio, this.dark, this.extraWide, this.imageStyle, this.responsiveSize, this.hideNav, this.selected.xofy, this.selected.alt, this.selected.id, this.selected.thumbnail, this.selected.sizing, this.selected.src, this.imageStyle, this.selected.details, this.selected.heading, this.selected.large, this.selected.tooltip, this.selected.alt, this.selected.tooltip, this.hideNav, !this.selected || this.selected.prev < 0, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_b673bc908a2611eaafc8a9b4dccb8bbb(), item.id, item.index, item.thumbnail, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel), "styles", this)), [(0, _litElement.css)(_templateObject3_b673bc908a2611eaafc8a9b4dccb8bbb())]);
      }
    }, {
      key: "properties",
      get: function get() {
