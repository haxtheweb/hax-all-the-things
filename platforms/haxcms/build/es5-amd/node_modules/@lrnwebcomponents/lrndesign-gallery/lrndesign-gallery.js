define(["exports", "../../lit-element/lit-element.js", "./lib/lrndesign-gallery-behaviors.js", "../responsive-utility/responsive-utility.js", "./lib/lrndesign-gallery-carousel.js", "./lib/lrndesign-gallery-grid.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _responsiveUtility, _lrndesignGalleryCarousel, _lrndesignGalleryGrid) {
  ...
  function _templateObject4_ab2832308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        ::slotted(figure) {\n          display: none;\n        }\n      "]);

    _templateObject4_ab2832308a2611eaafc8a9b4dccb8bbb = function _templateObject4_ab2832308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_ab2832308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-carousel\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                sizing=\"", "\"\n                .sources=\"", "\"\n                gallery-title=\"", "\"\n              >\n                <slot></slot>\n              </lrndesign-gallery-carousel>\n            "]);

    _templateObject3_ab2832308a2611eaafc8a9b4dccb8bbb = function _templateObject3_ab2832308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_ab2832308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-grid\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                sizing=\"", "\"\n                .sources=\"", "\"\n                gallery-title=\"", "\"\n              >\n                <slot></slot>\n              </lrndesign-gallery-grid>\n            "]);

    _templateObject2_ab2832308a2611eaafc8a9b4dccb8bbb = function _templateObject2_ab2832308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_ab2832308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"gallery\">\n        ", "\n      </div>\n    "]);

    _templateObject_ab2832308a2611eaafc8a9b4dccb8bbb = function _templateObject_ab2832308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGallery, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_ab2832308a2611eaafc8a9b4dccb8bbb(), this.grid ? (0, _litElement.html)(_templateObject2_ab2832308a2611eaafc8a9b4dccb8bbb(), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.sizing, this.items, this.galleryTitle) : (0, _litElement.html)(_templateObject3_ab2832308a2611eaafc8a9b4dccb8bbb(), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this.goToItem(e.detail);
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGallery), "styles", this)), [(0, _litElement.css)(_templateObject4_ab2832308a2611eaafc8a9b4dccb8bbb())]);
      }
    }, {
      key: "properties",
      get: function get() {
