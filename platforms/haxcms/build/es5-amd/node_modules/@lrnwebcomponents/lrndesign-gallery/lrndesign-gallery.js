define(["exports", "../../lit-element/lit-element.js", "./lib/lrndesign-gallery-behaviors.js", "../responsive-utility/responsive-utility.js", "./lib/lrndesign-gallery-carousel.js", "./lib/lrndesign-gallery-grid.js", "./lib/lrndesign-gallery-masonry.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _responsiveUtility, _lrndesignGalleryCarousel, _lrndesignGalleryGrid, _lrndesignGalleryMasonry) {
  ...
  function _templateObject5_0caf97e0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        ::slotted(figure) {\n          display: block;\n          margin-top: 15px;\n          margin-bottom: 15px;\n          max-width: 400px;\n          max-height: 400px;\n          display: block;\n          border: 1px solid #ddd;\n          page-break-inside: avoid;\n        }\n\n        @media screen {\n          ::slotted(figure) {\n            display: none;\n          }\n        }\n      "]);

    _templateObject5_0caf97e0b4c611eaada595ac6eca7bce = function _templateObject5_0caf97e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject4_0caf97e0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-carousel\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                sizing=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-carousel>\n            "]);

    _templateObject4_0caf97e0b4c611eaada595ac6eca7bce = function _templateObject4_0caf97e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject3_0caf97e0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-grid\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                sizing=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-grid>\n            "]);

    _templateObject3_0caf97e0b4c611eaada595ac6eca7bce = function _templateObject3_0caf97e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject2_0caf97e0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-masonry\n                accent-color=\"", "\"\n                .aspect-ratio=\"", "\"\n                .extra-wide=\"", "\"\n                ?dark=\"", "\"\n                .gallery-id=\"", "\"\n                @item-changed=\"", "\"\n                responsive-size=\"", "\"\n                .selected=\"", "\"\n                .sources=\"", "\"\n              >\n              </lrndesign-gallery-masonry>\n            "]);

    _templateObject2_0caf97e0b4c611eaada595ac6eca7bce = function _templateObject2_0caf97e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_0caf97e0b4c611eaada595ac6eca7bce() {
    ...
    _templateObject_0caf97e0b4c611eaada595ac6eca7bce = function _templateObject_0caf97e0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGallery, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_0caf97e0b4c611eaada595ac6eca7bce(), this.aspectRatio, 100 / this.aspectRatio, this.layout === "masonry" ? (0, _litElement.html)(_templateObject2_0caf97e0b4c611eaada595ac6eca7bce(), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.items) : this.grid || this.layout === "grid" ? (0, _litElement.html)(_templateObject3_0caf97e0b4c611eaada595ac6eca7bce(), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
        }, this.responsiveSize, this.selected, this.sizing === "cover" || "contain", this.items) : (0, _litElement.html)(_templateObject4_0caf97e0b4c611eaada595ac6eca7bce(), this.accentColor, this.aspect, this.extra, this.dark, this.id, function (e) {
          return _this2.goToItem(e.detail);
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGallery), "styles", this)), [(0, _litElement.css)(_templateObject5_0caf97e0b4c611eaada595ac6eca7bce())]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
