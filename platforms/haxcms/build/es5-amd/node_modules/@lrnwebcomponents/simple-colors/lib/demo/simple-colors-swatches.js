define(["exports", "require", "../../../../lit-element/lit-element.js", "../../simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
  ...
  function _templateObject4_bda9beb08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject4_bda9beb08a2611eaafc8a9b4dccb8bbb = function _templateObject4_bda9beb08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_bda9beb08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <button\n                      id=\"", "\"\n                      controls=\"swatchinfo\"\n                      style=\"background-color: ", ";\"\n                      title=\"", "\"\n                      @click=\"", "\"\n                    >\n                      <div>", "</div>\n                    </button>\n                  "]);

    _templateObject3_bda9beb08a2611eaafc8a9b4dccb8bbb = function _templateObject3_bda9beb08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_bda9beb08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"row\">\n                ", "\n              </div>\n            "]);

    _templateObject2_bda9beb08a2611eaafc8a9b4dccb8bbb = function _templateObject2_bda9beb08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_bda9beb08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div>\n        <p>Click on the swatches above to learn more.</p>\n        <div class=\"rows\">\n          ", "\n        </div>\n        <simple-modal-template id=\"modal\" title=\"", "\">\n          <p slot=\"content\">\n            <simple-colors-swatch-info\n              swatch-id=\"", "\"\n              swatch-name=\"", "\"\n            >\n            </simple-colors-swatch-info>\n          </p>\n        </simple-modal-template>\n      </div>\n    "]);

    _templateObject_bda9beb08a2611eaafc8a9b4dccb8bbb = function _templateObject_bda9beb08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(simpleColorsSwatches, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_bda9beb08a2611eaafc8a9b4dccb8bbb(), Object.keys(this.colors).map(function (color) {
          return (0, _litElement.html)(_templateObject2_bda9beb08a2611eaafc8a9b4dccb8bbb(), _this2.colors.grey.map(function (shade, index) {
            return (0, _litElement.html)(_templateObject3_bda9beb08a2611eaafc8a9b4dccb8bbb(), _this2._getId(color, index), _this2.colors[color][index], _this2._getTitle(color, index), function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatches), "styles", this)), [(0, _litElement.css)(_templateObject4_bda9beb08a2611eaafc8a9b4dccb8bbb())]);
      }
    }, {
      key: "properties",
      get: function get() {
