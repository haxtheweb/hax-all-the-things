define(["exports", "../../../../lit-element/lit-element.js", "../../simple-colors.js"], function (_exports, _litElement, _simpleColors) {
  ...
  function _templateObject5_f430a1f0229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: 15px 0;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        :host table {\n          width: 100%;\n          border: 1px solid black;\n          border-radius: 3px;\n          border-collapse: collapse;\n          margin: 0 0 15px;\n        }\n        :host table caption {\n          font-weight: bold;\n          background-color: #222;\n          color: white;\n        }\n        :host table th {\n          background-color: #e0e0e0;\n        }\n        :host table caption,\n        :host table th,\n        :host table td {\n          padding: 5px;\n          border: 1px solid black;\n          text-align: left;\n          line-height: 160%;\n        }\n        :host table td span {\n          padding: 5px;\n          white-space: nowrap;\n          margin: 5px 0;\n        }\n      "]);

    _templateObject5_f430a1f0229911ea85c7378a1f0d905a = function _templateObject5_f430a1f0229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject4_f430a1f0229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                        <span\n                          class=\"contrast\"\n                          style=\"", "\"\n                          >", "-", "</span\n                        >\n                      "]);

    _templateObject4_f430a1f0229911ea85c7378a1f0d905a = function _templateObject4_f430a1f0229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject3_f430a1f0229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                        <span\n                          class=\"contrast\"\n                          style=\"", "\"\n                          >", "-", "</span\n                        >\n                      "]);

    _templateObject3_f430a1f0229911ea85c7378a1f0d905a = function _templateObject3_f430a1f0229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject2_f430a1f0229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                <th scope=\"row\">", "</th>\n                <td>\n                  ", "\n                </td>\n                <td>\n                  ", "\n                </td>\n              </tr>\n            "]);

    _templateObject2_f430a1f0229911ea85c7378a1f0d905a = function _templateObject2_f430a1f0229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject_f430a1f0229911ea85c7378a1f0d905a() {
    ...
    _templateObject_f430a1f0229911ea85c7378a1f0d905a = function _templateObject_f430a1f0229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(simpleColorsSwatchInfo, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_f430a1f0229911ea85c7378a1f0d905a(), this.swatchName, this.swatchName, this._getBg(this.swatchId), this._getInverseBg(this.swatchId), this.swatchName, this._getBg(this.swatchId), this._getBg(this.swatchId), this.swatchName, this._getOptions(this.colors).map(function (color) {
          return (0, _litElement.html)(_templateObject2_f430a1f0229911ea85c7378a1f0d905a(), color, _this2._getAa(_this2.swatchId, color).map(function (contrast) {
            return (0, _litElement.html)(_templateObject3_f430a1f0229911ea85c7378a1f0d905a(), _this2._getContrastBg(color, contrast), color, contrast);
          }), _this2._getAaLarge(_this2.swatchId, color).map(function (contrast) {
            return (0, _litElement.html)(_templateObject4_f430a1f0229911ea85c7378a1f0d905a(), _this2._getContrastBg(color, contrast), color, contrast);
          }));
        }));
      }
    }], [{
      key: "styles",
      get: function get() {
        return [babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatchInfo), "styles", this), (0, _litElement.css)(_templateObject5_f430a1f0229911ea85c7378a1f0d905a())];
      }
    }]);
