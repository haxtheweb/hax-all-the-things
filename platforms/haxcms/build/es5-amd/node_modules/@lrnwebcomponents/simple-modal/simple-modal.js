define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/paper-dialog/paper-dialog.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _paperDialog, _customStyle) {
  ...
  function _templateObject2_b25708608a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject2_b25708608a2611eaafc8a9b4dccb8bbb = function _templateObject2_b25708608a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b25708608a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b25708608a2611eaafc8a9b4dccb8bbb = function _templateObject_b25708608a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b25708608a2611eaafc8a9b4dccb8bbb(), this._getAriaLabel(this.title), this._getAriaLabelledby(this.title), this.opened, this.openedChangedEvent, this.modal, !this.title, this.title, !this.opened, this.closeLabel, this.closeIcon);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b25708608a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
