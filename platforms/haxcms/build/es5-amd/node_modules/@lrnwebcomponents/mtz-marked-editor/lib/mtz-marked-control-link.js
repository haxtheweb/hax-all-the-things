define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/iron-a11y-keys/iron-a11y-keys.js", "../../../@polymer/paper-icon-button/paper-icon-button.js", "./mtz-marked-control-behavior.js"], function (_exports, _polymerElement, _ironA11yKeys, _paperIconButton, _mtzMarkedControlBehavior) {
  ...
  function _templateObject_b838c5208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: inline-block;\n        }\n      </style>\n\n      <paper-icon-button\n        icon=\"[[icon]]\"\n        noink=\"[[noink]]\"\n        on-click=\"_handleCommand\"\n        alt=\"[[title]]\"\n      ></paper-icon-button>\n\n      <iron-a11y-keys\n        keys=\"[[keys]]\"\n        on-keys-pressed=\"_handleCommand\"\n        target=\"[[__editor]]\"\n      ></iron-a11y-keys>\n    "]);

    _templateObject_b838c5208a2611eaafc8a9b4dccb8bbb = function _templateObject_b838c5208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_mtzMarkedControlBeha) {
    ...
    babelHelpers.createClass(MtzMarkedControlLink, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_b838c5208a2611eaafc8a9b4dccb8bbb());
      }
    }, {
      key: "tag",
      get: function get() {
