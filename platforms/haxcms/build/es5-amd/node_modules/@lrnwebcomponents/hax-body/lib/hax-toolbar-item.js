define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/paper-button/paper-button.js", "../../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _paperButton, _simpleTooltip) {
  ...
  function _templateObject2_b5c7c5208a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject2_b5c7c5208a2611eaafc8a9b4dccb8bbb = function _templateObject2_b5c7c5208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b5c7c5208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        .disabled=\"", "\"\n        id=\"btn\"\n        tabindex=\"0\"\n        .title=\"", "\"\n      >\n        <iron-icon\n          icon=\"", "\"\n          ?hidden=\"", "\"\n        ></iron-icon>\n        <span id=\"label\" ?hidden=\"", "\"\n          >", "</span\n        >\n        <slot></slot>\n      </paper-button>\n      <simple-tooltip\n        for=\"btn\"\n        ?hidden=\"", "\"\n        id=\"tooltip\"\n        offset=\"10\"\n        position=\"", "\"\n      >\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject_b5c7c5208a2611eaafc8a9b4dccb8bbb = function _templateObject_b5c7c5208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b5c7c5208a2611eaafc8a9b4dccb8bbb(), this.disabled, this.tooltip, this.icon, this.icon == "" ? true : false, this.label == "" ? true : false, this.label, this.tooltip == "" ? true : false, this.tooltipDirection, this.tooltip);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b5c7c5208a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "tag",
      get: function get() {
