define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject3_b4cff7a08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <hax-tray-button\n                id=\"picker-item-", "\"\n                @click=\"", "\"\n                data-selected=\"", "\"\n                label=\"", "\"\n                icon=\"", "\"\n                color=\"", "\"\n                ?color-meaning=\"", "\"\n              >\n              </hax-tray-button>\n            "]);

    _templateObject3_b4cff7a08a2611eaafc8a9b4dccb8bbb = function _templateObject3_b4cff7a08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b4cff7a08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-dialog id=\"dialog\" ?opened=\"", "\">\n        <h3 id=\"title\">", "</h3>\n        <div class=\"button-list\">\n          ", "\n        </div>\n        <paper-button id=\"closedialog\" @click=\"", "\">\n          <iron-icon icon=\"icons:cancel\" title=\"Close dialog\"></iron-icon>\n        </paper-button>\n      </paper-dialog>\n    "]);

    _templateObject2_b4cff7a08a2611eaafc8a9b4dccb8bbb = function _templateObject2_b4cff7a08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b4cff7a08a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b4cff7a08a2611eaafc8a9b4dccb8bbb = function _templateObject_b4cff7a08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  */
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxAppPicker, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_b4cff7a08a2611eaafc8a9b4dccb8bbb())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppPicker, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_b4cff7a08a2611eaafc8a9b4dccb8bbb(), this.opened, this.title, this.selectionList.map(function (element, index) {
          return (0, _litElement.html)(_templateObject3_b4cff7a08a2611eaafc8a9b4dccb8bbb(), index, _this2._selected, index, element.title, element.icon, element.color, _this2.selectionList.length === 2);
        }), this.closeEvent);
      }
    }, {
      key: "closeEvent",
