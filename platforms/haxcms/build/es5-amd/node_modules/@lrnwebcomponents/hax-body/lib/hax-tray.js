define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js", "../../hax-body-behaviors/lib/HAXFields.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse, _HAXFields) {
  ...
  function _templateObject4_b613c2408a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject4_b613c2408a2611eaafc8a9b4dccb8bbb = function _templateObject4_b613c2408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_b613c2408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hax-tray-button\n                    mini\n                    @click=\"", "\"\n                    icon=\"save\"\n                    id=\"haxsavebutton\"\n                    label=\"", "\"\n                    event-name=\"save\"\n                    voice-command=\"save (content)(page)\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    icon=\"cancel\"\n                    id=\"haxcancelbutton\"\n                    label=\"Cancel\"\n                    event-name=\"cancel\"\n                    voice-command=\"cancel\"\n                    color-meaning\n                  ></hax-tray-button>\n                "]);

    _templateObject3_b613c2408a2611eaafc8a9b4dccb8bbb = function _templateObject3_b613c2408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b613c2408a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              voice-command=\"edit page\"\n              .data-opened=\"", "\"\n              @click=\"", "\"\n              icon=\"create\"\n              id=\"button\"\n              label=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject2_b613c2408a2611eaafc8a9b4dccb8bbb = function _templateObject2_b613c2408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b613c2408a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject_b613c2408a2611eaafc8a9b4dccb8bbb = function _templateObject_b613c2408a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b613c2408a2611eaafc8a9b4dccb8bbb(), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_b613c2408a2611eaafc8a9b4dccb8bbb(), this.editMode, this._clickEditButton, this.__tipText), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject3_b613c2408a2611eaafc8a9b4dccb8bbb(), this._clickSaveButton, this.__tipText), this.traySizeIcon, this.traySizeText, this.menuAlignName, !this.canUndo, !this.canRedo, this.hidePreferencesButton, this._gizmoBrowserRefresh, this.activeTagIcon, this.activeTagName, _HAXFields.HaxSchematizer, _HAXFields.HaxElementizer, this._appBrowserRefresh, this._refreshLists);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_b613c2408a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "properties",
      get: function get() {
