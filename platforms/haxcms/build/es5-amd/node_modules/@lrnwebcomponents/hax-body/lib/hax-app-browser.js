define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "./hax-tray-button.js"], function (_exports, _require, _litElement, _utils, _haxTrayButton) {
  ...
  function _templateObject3_132c3510b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_132c3510b4c611eaada595ac6eca7bce = function _templateObject3_132c3510b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject2_132c3510b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"item-wrapper\">\n        ", "\n      </div>\n      <hax-app-search\n        id=\"haxappsearch\"\n        .hidden=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "]);

    _templateObject2_132c3510b4c611eaada595ac6eca7bce = function _templateObject2_132c3510b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function _templateObject_132c3510b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host *[hidden] {\n          display: none;\n        }\n        .toolbar-inner {\n          display: block;\n          padding: 0;\n          width: 100%;\n        }\n        .item-wrapper {\n          text-align: center;\n        }\n      "]);

    _templateObject_132c3510b4c611eaada595ac6eca7bce = function _templateObject_132c3510b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_132c3510b4c611eaada595ac6eca7bce())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_132c3510b4c611eaada595ac6eca7bce(), this.appList.map(function (app) {
          return (0, _litElement.html)(_templateObject3_132c3510b4c611eaada595ac6eca7bce(), app.index, app.details.title, app.details.icon, app.details.color, app.index);
        }), !this.searching);
      }
    }, {
      key: "firstUpdated",
