define(["exports", "require", "../../../lit-element/lit-element.js", "../../grafitto-filter/grafitto-filter.js", "../../utils/utils.js", "./hax-tray-button.js", "../../simple-fields/lib/simple-fields-field.js"], function (_exports, _require, _litElement, _grafittoFilter, _utils, _haxTrayButton, _simpleFieldsField) {
  ...
  function _templateObject3_004f2780856511eaa66301b3a4f2e8c5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              index=\"", "\"\n              label=\"", "\"\n              icon=\"", "\"\n              color=\"", "\"\n              event-name=\"search-selected\"\n              event-data=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject3_004f2780856511eaa66301b3a4f2e8c5 = function _templateObject3_004f2780856511eaa66301b3a4f2e8c5() {
      return data;
    };
  ...
  function _templateObject2_004f2780856511eaa66301b3a4f2e8c5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"toolbar-inner\">\n        <simple-fields-field\n          id=\"inputfilter\"\n          @value-changed=\"", "\"\n          aria-controls=\"filter\"\n          label=\"Filter\"\n          type=\"text\"\n          auto-validate=\"\"\n        ></simple-fields-field>\n      </div>\n      <grafitto-filter\n        id=\"filter\"\n        .items=\"", "\"\n        like=\"\"\n        @filtered-changed=\"", "\"\n        where=\"details.title\"\n        ><template></template\n      ></grafitto-filter>\n      <div class=\"item-wrapper\">\n        ", "\n      </div>\n      <hax-app-search\n        id=\"haxappsearch\"\n        .hidden=\"", "\"\n      ></hax-app-search>\n      <slot></slot>\n    "]);

    _templateObject2_004f2780856511eaa66301b3a4f2e8c5 = function _templateObject2_004f2780856511eaa66301b3a4f2e8c5() {
      return data;
    };
  ...
  function _templateObject_004f2780856511eaa66301b3a4f2e8c5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host *[hidden] {\n          display: none;\n        }\n        grafitto-filter {\n          color: black;\n        }\n        .toolbar-inner {\n          display: block;\n          padding: 0;\n          width: 100%;\n        }\n        .item-wrapper {\n          text-align: center;\n        }\n      "]);

    _templateObject_004f2780856511eaa66301b3a4f2e8c5 = function _templateObject_004f2780856511eaa66301b3a4f2e8c5() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxAppBrowser, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_004f2780856511eaa66301b3a4f2e8c5())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_004f2780856511eaa66301b3a4f2e8c5(), this.inputfilterChanged, this.appList, this.filteredChanged, this.filtered.map(function (app) {
          return (0, _litElement.html)(_templateObject3_004f2780856511eaa66301b3a4f2e8c5(), app.index, app.details.title, app.details.icon, app.details.color, app.index);
        }), !this.searching);
      }
    }, {
      key: "filteredChanged",
