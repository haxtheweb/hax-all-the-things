define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-a11y-keys/iron-a11y-keys.js", "./hax-toolbar-item.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icons/editor-icons.js", "../../../@polymer/iron-icons/device-icons.js", "../../../@polymer/iron-icons/hardware-icons.js", "../../../@polymer/iron-icons/social-icons.js", "../../../@polymer/iron-icons/av-icons.js", "../../../@polymer/iron-icons/image-icons.js", "../../../@polymer/iron-icons/maps-icons.js", "../../../@polymer/neon-animation/neon-animation.js"], function (_exports, _litElement, _ironA11yKeys, _haxToolbarItem, _ironIcons, _editorIcons, _deviceIcons, _hardwareIcons, _socialIcons, _avIcons, _imageIcons, _mapsIcons, _neonAnimation) {
  ...
  function _templateObject2_edff3e90229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-a11y-keys\n        id=\"a11y\"\n        keys=\"enter\"\n        @keys-pressed=\"", "\"\n      ></iron-a11y-keys>\n      <hax-toolbar-item\n        id=\"button\"\n        icon=\"", "\"\n        .hidden=\"", "\"\n        tooltip-direction=\"", "\"\n        tooltip=\"", "\"\n        @mousedown=\"", "\"\n        .mini=\"", "\"\n        .menu=\"", "\"\n        .light=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject2_edff3e90229911ea85c7378a1f0d905a = function _templateObject2_edff3e90229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function _templateObject_edff3e90229911ea85c7378a1f0d905a() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          box-sizing: border-box;\n          height: 36px;\n          width: 36px;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject_edff3e90229911ea85c7378a1f0d905a = function _templateObject_edff3e90229911ea85c7378a1f0d905a() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItemTextop, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_edff3e90229911ea85c7378a1f0d905a())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxContextItemTextop, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_edff3e90229911ea85c7378a1f0d905a(), this._fireEvent, this.icon, !this.icon, this.direction, this.label, this._fireEvent, this.mini, this.menu, this.light);
      }
    }, {
      key: "firstUpdated",
