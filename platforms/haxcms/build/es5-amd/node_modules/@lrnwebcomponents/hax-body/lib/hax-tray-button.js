define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/paper-button/paper-button.js", "../../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _simpleColors, _paperButton, _simpleTooltip) {
  ...
  function _templateObject7_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    ...
    _templateObject7_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject7_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject6_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <simple-tooltip>", "</simple-tooltip>\n          "]);

    _templateObject6_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject6_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject5_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"item-label\">", "</div>\n            "]);

    _templateObject5_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject5_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject4_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject4_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject3_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject3_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject3_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"button-inner\">\n                <iron-icon icon=\"", "\"></iron-icon>\n              </div>\n            "]);

    _templateObject2_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject2_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b5db4d208a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button title=\"", "\" @click=\"", "\">\n        ", "\n        ", "\n      </paper-button>\n      ", "\n    "]);

    _templateObject_b5db4d208a2611eaafc8a9b4dccb8bbb = function _templateObject_b5db4d208a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HAXTrayButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b5db4d208a2611eaafc8a9b4dccb8bbb(), this.label, this._fireEvent, this.icon ? (0, _litElement.html)(_templateObject2_b5db4d208a2611eaafc8a9b4dccb8bbb(), this.icon) : (0, _litElement.html)(_templateObject3_b5db4d208a2611eaafc8a9b4dccb8bbb()), this.mini ? (0, _litElement.html)(_templateObject4_b5db4d208a2611eaafc8a9b4dccb8bbb()) : (0, _litElement.html)(_templateObject5_b5db4d208a2611eaafc8a9b4dccb8bbb(), this.label), this.mini ? (0, _litElement.html)(_templateObject6_b5db4d208a2611eaafc8a9b4dccb8bbb(), this.label) : "");
      }
    }, {
      key: "_focusIn",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HAXTrayButton), "styles", this)), [(0, _litElement.css)(_templateObject7_b5db4d208a2611eaafc8a9b4dccb8bbb())]);
      }
    }]);
