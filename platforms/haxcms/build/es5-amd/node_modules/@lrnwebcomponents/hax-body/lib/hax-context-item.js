define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js"], function (_exports, _litElement, _haxToolbarItem) {
  ...
  function _templateObject3_b51824308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject3_b51824308a2611eaafc8a9b4dccb8bbb = function _templateObject3_b51824308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject2_b51824308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <iron-icon icon=\"icons:expand-more\"></iron-icon>\n            "]);

    _templateObject2_b51824308a2611eaafc8a9b4dccb8bbb = function _templateObject2_b51824308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b51824308a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        ?disabled=\"", "\"\n        ?light=\"", "\"\n        ?action=\"", "\"\n        ?mini=\"", "\"\n        ?large=\"", "\"\n        id=\"button\"\n        height=\"", "\"\n        icon=\"", "\"\n        ?hidden=\"", "\"\n        icon-class=\"", "\"\n        @mousedown=\"", "\"\n        @click=\"", "\"\n        tooltip=\"", "\"\n        tooltip-direction=\"", "\"\n        ?default=\"", "\"\n        ?menu=\"", "\"\n      >\n        ", "\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_b51824308a2611eaafc8a9b4dccb8bbb = function _templateObject_b51824308a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b51824308a2611eaafc8a9b4dccb8bbb(), this.disabled, this.light, this.action, this.mini, this.large, this.height, this.icon, !this.icon, this.iconClass, this._storeSelection, this._fireEvent, this.label, this.direction, this.default, this.menu, this.more ? (0, _litElement.html)(_templateObject2_b51824308a2611eaafc8a9b4dccb8bbb()) : "");
      }
    }, {
      key: "_storeSelection",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_b51824308a2611eaafc8a9b4dccb8bbb())];
      }
    }, {
      key: "tag",
      get: function get() {
