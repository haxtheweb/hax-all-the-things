define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icons/editor-icons.js", "../../../@polymer/iron-icons/device-icons.js", "../../../@polymer/iron-icons/hardware-icons.js", "../../../@polymer/iron-icons/social-icons.js", "../../../@polymer/iron-icons/av-icons.js", "../../../@polymer/iron-icons/image-icons.js", "../../../@polymer/iron-icons/maps-icons.js", "../../../@polymer/neon-animation/neon-animation.js"], function (_exports, _litElement, _haxToolbarItem, _ironIcons, _editorIcons, _deviceIcons, _hardwareIcons, _socialIcons, _avIcons, _imageIcons, _mapsIcons, _neonAnimation) {
  ...
  function _templateObject2_27bc4e701b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          height: 36px;\n          width: 36px;\n        }\n        :host([mini]) {\n          height: unset;\n          width: unset;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject2_27bc4e701b7411eab0b3b7b8d9dcf584 = function _templateObject2_27bc4e701b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_27bc4e701b7411eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        .disabled=\"", "\"\n        .light=\"", "\"\n        .mini=\"", "\"\n        id=\"button\"\n        icon=\"", "\"\n        .hidden=\"", "\"\n        icon-class=\"", "\"\n        @mousedown=\"", "\"\n        @click=\"", "\"\n        tooltip=\"", "\"\n        tooltip-direction=\"", "\"\n        .default=\"", "\"\n        .menu=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject_27bc4e701b7411eab0b3b7b8d9dcf584 = function _templateObject_27bc4e701b7411eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_27bc4e701b7411eab0b3b7b8d9dcf584(), this.disabled, this.light, this.mini, this.icon, !this.icon, this.iconClass, this._storeSelection, this._fireEvent, this.label, this.direction, this.default, this.menu);
      }
    }, {
      key: "_storeSelection",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_27bc4e701b7411eab0b3b7b8d9dcf584())];
      }
    }, {
      key: "tag",
      get: function get() {
