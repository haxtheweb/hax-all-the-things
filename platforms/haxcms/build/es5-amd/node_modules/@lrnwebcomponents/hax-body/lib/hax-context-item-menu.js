define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-menu.js", "../../simple-tooltip/simple-tooltip.js", "../../../@polymer/paper-item/paper-item.js", "../../../@polymer/neon-animation/neon-animation.js"], function (_exports, _litElement, _haxToolbarMenu, _simpleTooltip, _paperItem, _neonAnimation) {
  ...
  function _templateObject2_b50cd9908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-menu\n        id=\"menu\"\n        ?mini=\"", "\"\n        ?action=\"", "\"\n        .icon=\"", "\"\n        .tooltip=\"", "\"\n        .tooltip-direction=\"", "\"\n        @selected-changed=\"", "\"\n        .selected=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-menu>\n    "]);

    _templateObject2_b50cd9908a2611eaafc8a9b4dccb8bbb = function _templateObject2_b50cd9908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_b50cd9908a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          box-sizing: border-box;\n        }\n        :host(mini) {\n          height: unset;\n          width: unset;\n        }\n      "]);

    _templateObject_b50cd9908a2611eaafc8a9b4dccb8bbb = function _templateObject_b50cd9908a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItemMenu, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_b50cd9908a2611eaafc8a9b4dccb8bbb())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxContextItemMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_b50cd9908a2611eaafc8a9b4dccb8bbb(), this.mini, this.action, this.icon, this.label, this.direction, this.selectedValueChanged, this.selectedValue);
      }
    }, {
