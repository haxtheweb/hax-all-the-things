define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
  ...
  function _templateObject6_e02a02a01b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <td>", "</td>\n                  "]);

    _templateObject6_e02a02a01b7311eab0b3b7b8d9dcf584 = function _templateObject6_e02a02a01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject5_e02a02a01b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "]);

    _templateObject5_e02a02a01b7311eab0b3b7b8d9dcf584 = function _templateObject5_e02a02a01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject4_e02a02a01b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <th scope=\"col\">", "</th>\n                "]);

    _templateObject4_e02a02a01b7311eab0b3b7b8d9dcf584 = function _templateObject4_e02a02a01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject3_e02a02a01b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "]);

    _templateObject3_e02a02a01b7311eab0b3b7b8d9dcf584 = function _templateObject3_e02a02a01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject2_e02a02a01b7311eab0b3b7b8d9dcf584() {
    ...
    _templateObject2_e02a02a01b7311eab0b3b7b8d9dcf584 = function _templateObject2_e02a02a01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function _templateObject_e02a02a01b7311eab0b3b7b8d9dcf584() {
    ...
    _templateObject_e02a02a01b7311eab0b3b7b8d9dcf584 = function _templateObject_e02a02a01b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(CsvRender, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_e02a02a01b7311eab0b3b7b8d9dcf584())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_e02a02a01b7311eab0b3b7b8d9dcf584(), this.dataSource, this.tableDataChanged, this.handleResponse, this.accentColor, this.dataSource, this.summary, this.caption ? (0, _litElement.html)(_templateObject3_e02a02a01b7311eab0b3b7b8d9dcf584(), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _litElement.html)(_templateObject4_e02a02a01b7311eab0b3b7b8d9dcf584(), _this3.heading);
        }), this.table.map(function (row) {
          return (0, _litElement.html)(_templateObject5_e02a02a01b7311eab0b3b7b8d9dcf584(), row.map(function (col) {
            return (0, _litElement.html)(_templateObject6_e02a02a01b7311eab0b3b7b8d9dcf584(), col);
          }));
        }));
      }
    }, {
