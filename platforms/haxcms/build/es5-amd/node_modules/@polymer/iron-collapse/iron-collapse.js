define(["../iron-resizable-behavior/iron-resizable-behavior.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/legacy/polymer.dom.js", "../polymer/lib/utils/html-tag.js", "../polymer/polymer-legacy.js"], function (_ironResizableBehavior, _polymerFn, _polymerDom, _htmlTag, _polymerLegacy) {
  ...
  function _templateObject_fd59ef201b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        transition-duration: var(--iron-collapse-transition-duration, 300ms);\n        /* Safari 10 needs this property prefixed to correctly apply the custom property */\n        -webkit-transition-duration: var(--iron-collapse-transition-duration, 300ms);\n        overflow: visible;\n      }\n\n      :host(.iron-collapse-closed) {\n        display: none;\n      }\n\n      :host(:not(.iron-collapse-opened)) {\n        overflow: hidden;\n      }\n    </style>\n\n    <slot></slot>\n"]);

    _templateObject_fd59ef201b7311eab0b3b7b8d9dcf584 = function _templateObject_fd59ef201b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_fd59ef201b7311eab0b3b7b8d9dcf584()),
    is: 'iron-collapse',
