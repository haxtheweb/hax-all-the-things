define(["../../polymer/polymer-legacy.js", "../../iron-flex-layout/iron-flex-layout.js", "../../iron-resizable-behavior/iron-resizable-behavior.js", "../../polymer/lib/legacy/polymer-fn.js", "../../polymer/lib/utils/html-tag.js", "../app-scroll-effects/app-scroll-effects-behavior.js"], function (_polymerLegacy, _ironFlexLayout, _ironResizableBehavior, _polymerFn, _htmlTag, _appScrollEffectsBehavior) {
  ...
  function _templateObject_27c026d0b4c611eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        position: relative;\n        display: block;\n      }\n\n      #background {\n        @apply --layout-fit;\n        overflow: hidden;\n        height: 100%;\n      }\n\n      #backgroundFrontLayer {\n        min-height: 100%;\n        pointer-events: none;\n        background-size: cover;\n        @apply --app-box-background-front-layer;\n      }\n\n      #contentContainer {\n        position: relative;\n        width: 100%;\n        height: 100%;\n      }\n\n      :host([disabled]),\n      :host([disabled]) #backgroundFrontLayer {\n        transition: none !important;\n      }\n    </style>\n\n    <div id=\"background\">\n      <div id=\"backgroundFrontLayer\">\n        <slot name=\"background\"></slot>\n      </div>\n    </div>\n    <div id=\"contentContainer\">\n      <slot></slot>\n    </div>\n"]);

    _templateObject_27c026d0b4c611eaada595ac6eca7bce = function _templateObject_27c026d0b4c611eaada595ac6eca7bce() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    /** @override */
    _template: (0, _htmlTag.html)(_templateObject_27c026d0b4c611eaada595ac6eca7bce()),
    is: 'app-box',
