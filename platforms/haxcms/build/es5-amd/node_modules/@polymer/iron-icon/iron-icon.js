define(["../iron-flex-layout/iron-flex-layout.js", "../iron-meta/iron-meta.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/legacy/polymer.dom.js", "../polymer/lib/utils/html-tag.js", "../polymer/polymer-legacy.js"], function (_ironFlexLayout, _ironMeta, _polymerFn, _polymerDom, _htmlTag, _polymerLegacy) {
  ...
  function _templateObject_f99c2ba0b4c511eaada595ac6eca7bce() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        @apply --layout-inline;\n        @apply --layout-center-center;\n        position: relative;\n\n        vertical-align: middle;\n\n        fill: var(--iron-icon-fill-color, currentcolor);\n        stroke: var(--iron-icon-stroke-color, none);\n\n        width: var(--iron-icon-width, 24px);\n        height: var(--iron-icon-height, 24px);\n        @apply --iron-icon;\n      }\n\n      :host([hidden]) {\n        display: none;\n      }\n    </style>\n"]);

    _templateObject_f99c2ba0b4c511eaada595ac6eca7bce = function _templateObject_f99c2ba0b4c511eaada595ac6eca7bce() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_f99c2ba0b4c511eaada595ac6eca7bce()),
    is: 'iron-icon',
    properties: {
      /**
