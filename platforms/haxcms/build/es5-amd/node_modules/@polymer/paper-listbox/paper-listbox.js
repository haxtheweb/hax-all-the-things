define(["../polymer/polymer-legacy.js", "../paper-styles/default-theme.js", "../iron-menu-behavior/iron-menu-behavior.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/utils/html-tag.js"], function (_polymerLegacy, _defaultTheme, _ironMenuBehavior, _polymerFn, _htmlTag) {
  ...
  function _templateObject_cb3a5c501b7311eab0b3b7b8d9dcf584() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        padding: 8px 0;\n\n        background: var(--paper-listbox-background-color, var(--primary-background-color));\n        color: var(--paper-listbox-color, var(--primary-text-color));\n\n        @apply --paper-listbox;\n      }\n    </style>\n\n    <slot></slot>\n"]);

    _templateObject_cb3a5c501b7311eab0b3b7b8d9dcf584 = function _templateObject_cb3a5c501b7311eab0b3b7b8d9dcf584() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_cb3a5c501b7311eab0b3b7b8d9dcf584()),
    is: 'paper-listbox',
