define(["exports", "../../tslib/tslib.es6.js", "../mwc-icon/mwc-icon.js", "../mwc-ripple/ripple-directive.js", "../../lit-element/lit-element.js", "../../lit-html/directives/class-map.js"], function (_exports, _tslibEs, _mwcIcon, _rippleDirective, _litElement, _classMap) {
  ...
  function _templateObject2_91f05ae08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <mwc-icon class=\"mdc-button__icon\">\n        ", "\n      </mwc-icon>"]);

    _templateObject2_91f05ae08a2611eaafc8a9b4dccb8bbb = function _templateObject2_91f05ae08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function _templateObject_91f05ae08a2611eaafc8a9b4dccb8bbb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n          id=\"button\"\n          class=\"mdc-button ", "\"\n          ?disabled=\"", "\"\n          aria-label=\"", "\">\n        <div class=\"mdc-button__ripple\"></div>\n        <span class=\"leading-icon\">\n          <slot name=\"icon\">\n            ", "\n          </slot>\n        </span>\n        <span class=\"mdc-button__label\">", "</span>\n        <slot></slot>\n        <span class=\"trailing-icon\">\n          <slot name=\"trailingIcon\">\n            ", "\n          </slot>\n        </span>\n      </button>"]);

    _templateObject_91f05ae08a2611eaafc8a9b4dccb8bbb = function _templateObject_91f05ae08a2611eaafc8a9b4dccb8bbb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ButtonBase, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_91f05ae08a2611eaafc8a9b4dccb8bbb(), (0, _classMap.classMap)(classes), this.disabled, this.label || this.icon, this.icon && !this.trailingIcon ? this.renderIcon(this.icon) : '', this.label, this.icon && this.trailingIcon ? this.renderIcon(this.icon) : '');
      }
    }, {
      key: "renderIcon",
      value: function renderIcon(icon) {
        return (0, _litElement.html)(_templateObject2_91f05ae08a2611eaafc8a9b4dccb8bbb(), icon);
      }
    }, {
      key: "firstUpdated",
